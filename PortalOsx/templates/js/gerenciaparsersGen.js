...
function Inicia()
{
   if (document.form1.ListaConfiguracoes.length == 0)
	{
		alert ("Não há configurações de parsersGen para iniciar!");
		return false;
	}
   ...
   if (Indice == -1)
	{
		alert ("Selecione uma configuração de parserGen para iniciá-la!");
		return false;
	}

   // Preenche o formulário 2
   document.form2.cfgparser.value = document.form1.ListaConfiguracoes.options[Indice].text;
   var Indice2 = document.form1.ListaServidores.selectedIndex;
   document.form2.servidor.value = document.form1.ListaServidores.options[Indice2].text;
   return true;
}
...
function Finaliza()
{
	if (document.form1.ListaConfiguracoes.length == 0)
	{
		alert ("Não há configurações de parsersGen para finalizar!");
		return false;
	}
	...
	if (Indice == -1)
	{
		alert ("Selecione uma configuração de parserGen para finalizá-la!");
		return false;
	}

	// Preenche o formulário 3
	document.form3.cfgparser.value = document.form1.ListaConfiguracoes.options[Indice].text;
	return true;
...
function Termina()
{
	if (document.form1.ListaConfiguracoes.length == 0)
	{
		alert ("Não há configurações de parsersGen para terminar!");
		return false;
	}
	...
	if (Indice == -1)
   {
		alert ("Selecione uma configuração de parserGen para terminá-la!");
		return false;
	}

	// Preenche o formulário 4
	document.form4.cfgparser.value = document.form1.ListaConfiguracoes.options[Indice].text;
	return true;
}