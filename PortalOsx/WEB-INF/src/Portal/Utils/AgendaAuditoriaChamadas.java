...
public class AgendaAuditoriaChamadas extends Agenda
{
   private String[] m_Rec = null;
   private String m_Indicadores;
   public Vector m_RelatoriosProcessados[] = null;
   public Vector m_IndicadoresAuditoriaChamadas;
   
   public AgendaAuditoriaChamadas(CnxServUtil p_ConexUtil, String p_Perfil, String p_TipoRel, String p_IdRel, String p_Arquivo, SelecaoIndicadorAuditoriaChamadas p_SelecaoIndicadorAuditoria, String p_IndicadoresAuditoriaChamadas, String p_NomeRel, String p_DataGer)
   {
      super(p_ConexUtil, p_Perfil, p_TipoRel, p_IdRel, p_Arquivo, p_NomeRel, p_DataGer);
      
      this.setM_SelecaoIndicador(p_SelecaoIndicadorAuditoria);
      this.setM_Rec(m_Rec);
      this.setM_ContadoresRelatorio(m_iRetRelatorio.fnGetContadores());
      
      m_IndicadoresAuditoriaChamadas = VetorUtil.String2Vetor(p_IndicadoresAuditoriaChamadas, ';');      
   ...
   {      
      ...
      // Loop em que sao adicionados todos os contadores do relatorio Auditoria de Chamadas
