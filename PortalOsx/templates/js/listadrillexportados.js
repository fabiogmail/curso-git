...
function AbreJanelaDrill(Operacao, Perfil, nomePerfil, Arquivo)
{
   NovaJanela = "";
   if (Operacao == "detalhar")
   { 
      URLStr = "/PortalOsx/servlet/Portal.cPortal?operacao=detalhaExportadoDrill&perfil="+Perfil+"&arquivo="+Arquivo+"&nomePerfil="+nomePerfil;
      NovaJanela = window.open(URLStr,'AUX','resizable=no,status=no,menubar=no,scrollbars=no,width=475,height=210');
      NovaJanela.focus();
   }
}
