//Source file: C:/usr/osx/CDRView/Servlet/Portal/Operacoes/OpApresentaRelAgendadoDistribuicaoDeFrequencia.java
...
import Portal.Utils.AgendaDistribuicaoDeFrequencia;
...
/**
 */
public class OpApresentaRelAgendadoDistribuicaoDeFrequencia extends OperacaoAbs 
{
...
*/         
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDistribuicaoDeFrequencia:iniciaOperacao() - Suboperacao nao encontrada: "+ m_SubOperacao);
   ...
   public void apresentaPagInicial() 
   {
      try
      {
         AgendaDistribuicaoDeFrequencia Ag = null;
         ...
         m_Args[3] = "DistribuicaoDeFrequencia";
         m_Args[4] = m_Perfil;
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDistribuicaoDeFrequencia:apresentaPagInicial(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaPagInicial2() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDistribuicaoDeFrequencia:apresentaPagInicial2(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaRelatorio() 
   {
      try
      {
         ...
         m_Args[2] = "DistribuicaoDeFrequencia";
         m_Args[3] = m_Perfil;
         ...
         m_Args[9] = "DistribuicaoDeFrequencia";
         m_Args[10] = m_Perfil;
         ...
         m_Args[16] = "DistribuicaoDeFrequencia";
         m_Args[17] = m_Perfil;
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDistribuicaoDeFrequencia:apresentaRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaTopoRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDistribuicaoDeFrequencia:apresentaTopoRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaMeioRelatorio() 
   {
      try
      {
         ...
         for (int j = 0; j < RelProcessado.size(); j++) 
         {
            ...
            int tamanho = LinhaRelProcessado.size();
            Vector Linhas2 = (Vector)Linhas.get(0);
            
        	String dados[] = ((String)Linhas2.get(j)).split(";");
        	for(int p=tamanho;p<dados.length-1;p++){
        		LinhaRelProcessado.add(dados[p]);
        	}
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDistribuicaoDeFrequencia:apresentaMeioRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaBaseRelatorio()
   {
      try
      {
         AgendaDistribuicaoDeFrequencia Ag;
         String Paginacao = "";
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDistribuicaoDeFrequencia:apresentaBaseRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaIndicadores()
   {
      try
      {
         ...
         {         	
            QtdIndicadores = Ag.m_IndicadoresDistribuicaoDeFrequencia.size();            
            for (i = 0; i < QtdIndicadores; i++)
               Indicadores1 += "                   <option value=\""+ Ag.m_IndicadoresDistribuicaoDeFrequencia.elementAt(i).toString() +"\">" + Ag.m_IndicadoresDistribuicaoDeFrequencia.elementAt(i).toString() + "</option>\n";
            Ag.m_IndicadoresPossiveis = Indicadores1;
         }

         if (Ag.m_Recv.get(1) != null){ 
         	i = 2;
         }else{ 
         	i = 1;
         }
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDistribuicaoDeFrequencia:apresentaIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaConfiguracao() 
   {
      try
      {
         ...
         m_Args[13] = "DistribuicaoDeFrequencia";
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDistribuicaoDeFrequencia:apresentaConfiguracao(): "+ Exc);
         Exc.printStackTrace();
      }    
   }
   ...
   public void apresentaRelatorioFinal() 
   {
      try
      {
         ...
         for (int z = 0; z < Ag.m_PeriodosApresentaveis.size(); z++)         
         {
            ...
            for (int j = 0; j < Tam; j++)            
            {
               ...
               /**
                * o jeito como a 'LinharelProcessado está sendo populada e devido ao fato
                * de os indicadores desse relatorio(indicadores de tempo) não serem tratados pela libjava,
                * entao os valores estao sendo colocados forçadamente. 
                */
               LinhaRelProcessado = (Vector)RelProcessado.elementAt(j);
               int tamanho = LinhaRelProcessado.size();
               Vector Linhas2 = (Vector)Ag.m_Linhas.get(0);
               
	           String dados[] = ((String)Linhas2.get(j)).split(";");
	           for(int p=tamanho+1;p<dados.length-1;p++){
	        	   LinhaRelProcessado.add(dados[p]);
	           }
               m_Html.envia("   <tr"+Cor+">\n   ");
               for (int k = 0; k < LinhaRelProcessado.size(); k++)
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDistribuicaoDeFrequencia:apresentaRelatorioFinal(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaSelecaoDePaginas() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDistribuicaoDeFrequencia:apresentaSelecaoDePaginas(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void apresentaLogs()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDistribuicaoDeFrequencia:apresentaLogs(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void alteraIndicadores()
   {
      try
      {
         ...
         if (Ag != null)
         {
            ...
            //antigamente o relatorio so podia ter 2 recursos, hoje ele pode ter mais.
            //if (Ag.m_Recv.get(1) != null)            
            if(Ag.m_Recv.size() > 1){
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDistribuicaoDeFrequencia:alteraIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void alteraConfiguracao() 
   {
      ...
      if (Usuario != null)
      {
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDistribuicaoDeFrequencia:alteraConfiguracao(): Usuario nao foi encontrado");
   }
...
/*   
      ...
      {
         System.out.println(m_ConexUtil.getDataHoraAtual() + " OpApresentaRelAgendadoDistribuicaoDeFrequencia:ordena(): "+ Exc);
         Exc.printStackTrace();
      }
*/      
   }
   ...
   public void home() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDistribuicaoDeFrequencia:home(): "+ Exc);
         Exc.printStackTrace();
      }
   }  
...
//         vCabecalho = new Vector (Ag.m_Cabecalho);
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDistribuicaoDeFrequencia:download(): "+ Exc);
         Exc.printStackTrace();         
      }
   }
   ...
   public static synchronized void removeAgenda(OpApresentaRelAgendadoDistribuicaoDeFrequencia p_Operacao)
   {
      try
      {
         AgendaDistribuicaoDeFrequencia Ag = null;
         ...
         s_MapAgendasDistFrequencia.remove(p_Operacao.m_KeyCache);
      }
      catch (Exception Exc)
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDistribuicaoDeFrequencia:removeAgenda(): Nao foi possivel remvoer a agenda com chave: "+p_Operacao.m_KeyCache);
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDistribuicaoDeFrequencia:removeAgenda(): "+ Exc);
         Exc.printStackTrace();
      }
   }

   public AgendaDistribuicaoDeFrequencia buscaAgenda() 
   {
   ...
   public static synchronized AgendaDistribuicaoDeFrequencia buscaAgenda(OpApresentaRelAgendadoDistribuicaoDeFrequencia p_Operacao)
   {
      Object ObjAg = null;
      AgendaDistribuicaoDeFrequencia Ag = null;
      
      if (s_MapAgendasDistFrequencia.size() == 0)
      {
         Ag = p_Operacao.criaAgenda();
         return Ag;
      }

      ObjAg = s_MapAgendasDistFrequencia.get(p_Operacao.m_KeyCache);
      if (ObjAg != null)
      {
         Ag = (AgendaDistribuicaoDeFrequencia)ObjAg;
      }
      else
      {
         Ag = p_Operacao.criaAgenda();
   ...
   public void insereAgenda(AgendaDistribuicaoDeFrequencia p_Agenda) 
   {
      synchronized(s_MapAgendasDistFrequencia)
      {
         s_MapAgendasDistFrequencia.put(m_KeyCache, p_Agenda);
      }      
   }

   public AgendaDistribuicaoDeFrequencia criaAgenda() 
   {
      boolean Retorno;
      AgendaDistribuicaoDeFrequencia Ag;
      UsuarioDef Usuario = (UsuarioDef)NoUtil.getUsuarioLogado(m_Request.getSession().getId());
      ...
      Ag = new AgendaDistribuicaoDeFrequencia(no.getConexaoServUtil(), 
                                m_Perfil, 
                                m_TipoRelatorio, 
                                m_IdRelatorio, 
                                m_NomeArquivoRelatorio, 
                                m_SelecaoRecursosDistFrequencia, 
                                m_SelecaoIndicadorDistFrequencia,
                                m_IndicadoresDistFrequencia,
                                m_NomeRelatorio,
                                m_DataGeracao);
      m_Agenda = Ag;
...
class DownloadRelAgendadoDistribuicaoDeFrequencia extends java.lang.Thread
   {
	 ...
	 */
	AgendaDistribuicaoDeFrequencia m_Ag = null;

      String m_NomeArq;      
      Vector m_vCabecalho;
      Vector m_CfgWeb;

      public DownloadRelAgendadoDistribuicaoDeFrequencia(String p_NomeArq, Vector p_vCabecalho, AgendaDistribuicaoDeFrequencia p_Ag, Vector p_CfgWeb)
      {
         m_Ag = p_Ag;
         m_NomeArq = p_NomeArq;
