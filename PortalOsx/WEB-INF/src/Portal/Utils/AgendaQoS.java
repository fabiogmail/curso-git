...
public class AgendaQoS extends Agenda
{ 
	public Vector m_Recv = null;
   private String m_Indicadores;
   public Vector m_RelatoriosProcessados[] = null;
   public Vector m_IndicadoresQoS;
   
   public AgendaQoS(CnxServUtil p_ConexUtil, String p_Perfil, String p_TipoRel, String p_IdRel, String p_Arquivo, SelecaoRecursosQoS p_SelecaoRecursosQoS, SelecaoIndicadorQoS p_SelecaoIndicadorQoS, String p_IndicadoresQoS, String p_NomeRel, String p_DataGer)
   {
      super(p_ConexUtil, p_Perfil, p_TipoRel, p_IdRel, p_Arquivo, p_NomeRel, p_DataGer);

      this.setM_SelecaoRecursos(p_SelecaoRecursosQoS);
      this.setM_SelecaoIndicador(p_SelecaoIndicadorQoS);
      this.setM_ContadoresRelatorio(m_iRetRelatorio.fnGetContadores());
      
      m_IndicadoresQoS = VetorUtil.String2Vetor(p_IndicadoresQoS, ';');
