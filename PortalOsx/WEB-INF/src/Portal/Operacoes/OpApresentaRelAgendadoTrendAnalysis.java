...
import Portal.Utils.AgendaTrendAnalysis;
...
/**
 */
public class OpApresentaRelAgendadoTrendAnalysis extends OperacaoAbs 
{
...
*/         
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoTrendAnalysis:iniciaOperacao() - Suboperacao nao encontrada: "+ m_SubOperacao);
   ...
   public void apresentaPagInicial() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoTrendAnalysis:apresentaPagInicial(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaPagInicial2() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoTrendAnalysis:apresentaPagInicial2(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoTrendAnalysis:apresentaRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaTopoRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoTrendAnalysis:apresentaTopoRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaMeioRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoTrendAnalysis:apresentaMeioRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaBaseRelatorio()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoTrendAnalysis:apresentaBaseRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaIndicadores()
   {
      try
      {
         ...
         {
            QtdIndicadores = Ag.m_IndicadoresTrendAnalysis.size();            
            for (i = 0; i < QtdIndicadores; i++)
               Indicadores1 += "                   <option value=\""+ Ag.m_IndicadoresTrendAnalysis.elementAt(i).toString() +"\">" + Ag.m_IndicadoresTrendAnalysis.elementAt(i).toString() + "</option>\n";
...
//            Indicadores2 += "                   <option value=\""+ Ag.m_vIndicadores.elementAt(i).toString() +"\">" + Ag.m_vIndicadores.elementAt(i).toString() + "</option>\n";
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoTrendAnalysis:apresentaIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaConfiguracao() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoTrendAnalysis:apresentaConfiguracao(): "+ Exc);
         Exc.printStackTrace();
      }    
   }
   ...
   public void apresentaRelatorioFinal() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoTrendAnalysis:apresentaRelatorioFinal(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaSelecaoDePaginas() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoTrendAnalysis:apresentaSelecaoDePaginas(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void apresentaLogs()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoTrendAnalysis:apresentaLogs(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
...
//               Indicadores = Ag.m_vIndicadores.elementAt(0).toString()+";"+ Ag.m_vIndicadores.elementAt(1).toString()+";"+Indicadores;
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoTrendAnalysis:alteraIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void alteraConfiguracao() 
   {
      ...
      if (Usuario != null)
      {
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoTrendAnalysis:alteraConfiguracao(): Usuario nao foi encontrado");
   }
...
/*   
      ...
      {
         System.out.println(m_ConexUtil.getDataHoraAtual() + " OpApresentaRelAgendadoTrendAnalysis:ordena(): "+ Exc);
         Exc.printStackTrace();
      }
*/      
   }
   ...
   public void home() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoTrendAnalysis:home(): "+ Exc);
         Exc.printStackTrace();
      }
   }  
...
//         vCabecalho = new Vector (Ag.m_Cabecalho);
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoTrendAnalysis:download(): "+ Exc);
         Exc.printStackTrace();         
      }
   }
   ...
   public static synchronized void removeAgenda(OpApresentaRelAgendadoTrendAnalysis p_Operacao)
   {
      try
      {
         AgendaTrendAnalysis Ag = null;
         ...
         s_MapAgendasTrendAnalysis.remove(p_Operacao.m_KeyCache);
      }
      catch (Exception Exc)
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoTrendAnalysis:removeAgenda(): Nao foi possivel remvoer a agenda com chave: "+p_Operacao.m_KeyCache);
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoTrendAnalysis:removeAgenda(): "+ Exc);
         Exc.printStackTrace();
      }
   }

   public AgendaTrendAnalysis buscaAgenda() 
   {
   ...
   public static synchronized AgendaTrendAnalysis buscaAgenda(OpApresentaRelAgendadoTrendAnalysis p_Operacao)
   {
      Object ObjAg = null;
      AgendaTrendAnalysis Ag = null;
      
      if (s_MapAgendasTrendAnalysis.size() == 0)
      {
         Ag = p_Operacao.criaAgenda();
         return Ag;
      }

      ObjAg = s_MapAgendasTrendAnalysis.get(p_Operacao.m_KeyCache);
      if (ObjAg != null)
      {
         Ag = (AgendaTrendAnalysis)ObjAg;
      }
      else
      {
         Ag = p_Operacao.criaAgenda();
   ...
   public void insereAgenda(AgendaTrendAnalysis p_Agenda) 
   {
      synchronized(s_MapAgendasTrendAnalysis)
      {
         s_MapAgendasTrendAnalysis.put(m_KeyCache, p_Agenda);
      }      
   }

   public AgendaTrendAnalysis criaAgenda() 
   {
      boolean Retorno;
      AgendaTrendAnalysis Ag;
      UsuarioDef Usuario = (UsuarioDef)NoUtil.getUsuarioLogado(m_Request.getSession().getId());
      ...
      Ag = new AgendaTrendAnalysis(no.getConexaoServUtil(), 
                                m_Perfil, 
                                m_TipoRelatorio, 
                                m_IdRelatorio, 
                                m_NomeArquivoRelatorio, 
                                m_SelecaoRecursosTrendAnalysis, 
                                m_SelecaoIndicadorTrendAnalysis,
                                m_IndicadoresTrendAnalysis,
                                m_NomeRelatorio,
                                m_DataGeracao);
      m_Agenda = Ag;
...
class DownloadRelAgendadoTrendAnalysis extends java.lang.Thread
   {
	 ...
	 */
	AgendaTrendAnalysis m_Ag = null;

      String m_NomeArq;      
      Vector m_vCabecalho;
      Vector m_CfgWeb;

      public DownloadRelAgendadoTrendAnalysis(String p_NomeArq, Vector p_vCabecalho, AgendaTrendAnalysis p_Ag, Vector p_CfgWeb)
      {
         m_Ag = p_Ag;
         m_NomeArq = p_NomeArq;
