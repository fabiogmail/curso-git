  ...
  <tr>
    <td rowspan="2" valign="top">
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
	    ...
	    <tr>
	      <td height="20" colspan="8" valign="middle" bgcolor="#000033" class="style2">&nbsp;Perfis que ser&atilde;o monitorados</td>
        </tr>
	    <tr>
	      <td colspan="3" rowspan="5" valign="middle">
	    ...
	    <tr>
	      <td height="20" colspan="8" valign="middle" bgcolor="#000033">
	    ...
	    <tr>
	      <td height="25" colspan="3" valign="middle"><strong>E-mail do remetente:</strong></td>
          <td colspan="2" valign="middle"><input type="text" id="email"></td>
          <td>&nbsp;</td>
          <td></td>
	      <td></td>
        </tr>
	    <tr>
          ...
          <td>&nbsp;</td>
          <td colspan="2" valign="middle"><input type="text" id="smtp"></td>
          <td>&nbsp;</td>
          <td></td>
	      <td></td>
        </tr>
	    ...
	    <tr>
	      <td height="25" align="left" valign="middle"><input type="checkbox" id="habilitar_email" name="habilitar_email"/></td>
