...
public class AgendaITXReceita extends Agenda
{
   //public String[] m_Rec = null;
   public  Vector m_Recv = null;
   private String m_Indicadores;
   public Vector m_RelatoriosProcessados[] = null;
   public Vector m_IndicadoresITXReceita;
   
   public AgendaITXReceita(CnxServUtil p_ConexUtil, String p_Perfil, String p_TipoRel, String p_IdRel, String p_Arquivo, SelecaoRecursosITXReceita p_SelecaoRecursosITXReceita, SelecaoIndicadorITXReceita p_SelecaoIndicadorITXReceita, String p_IndicadoresITXReceita, String p_NomeRel, String p_DataGer)
   {
      super(p_ConexUtil, p_Perfil, p_TipoRel, p_IdRel, p_Arquivo, p_NomeRel, p_DataGer);

      this.setM_SelecaoRecursos(p_SelecaoRecursosITXReceita);
      this.setM_SelecaoIndicador(p_SelecaoIndicadorITXReceita);
      this.setM_ContadoresRelatorio(m_iRetRelatorio.fnGetContadores());
      
      m_IndicadoresITXReceita = VetorUtil.String2Vetor(p_IndicadoresITXReceita, ';');
