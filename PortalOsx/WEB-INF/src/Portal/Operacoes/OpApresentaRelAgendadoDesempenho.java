...
import Portal.Utils.AgendaDesempenho;
...
/**
 */
public class OpApresentaRelAgendadoDesempenho extends OperacaoAbs 
{
...
*/         
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDesempenho:iniciaOperacao() - Suboperacao nao encontrada: "+ m_SubOperacao);
   ...
   public void apresentaPagInicial() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDesempenho:apresentaPagInicial(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaPagInicial2() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDesempenho:apresentaPagInicial2(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDesempenho:apresentaRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaTopoRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDesempenho:apresentaTopoRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaMeioRelatorio() 
   {
      try
      {
         ...
         {
        	 Thread.sleep(500);
            if (Periodo == null && Ag.m_UltProcessado == 0) 
            	iPeriodo = 0;
            else if (Periodo == null && Ag.m_UltProcessado != 0)
            	iPeriodo = Ag.m_UltProcessado;
            else 
            	iPeriodo = Integer.parseInt(Periodo);
         }
         catch (Exception Exc)
         {
            iPeriodo = 0;
         ...
         for (int i = 0; i < Ag.m_QtdPeriodos; i++)
         {
            ...
            if (Ag.m_NomesDatas != null) 
            	NomePeriodo = Ag.m_NomesDatas.elementAt(i).toString();
            else 
            	NomePeriodo = Ag.m_Datas.elementAt(i).toString();
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDesempenho:apresentaMeioRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaBaseRelatorio()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDesempenho:apresentaBaseRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaIndicadores()
   {
      try
      {
         ...
         {
            QtdIndicadores = Ag.m_IndicadoresDesempenho.size();            
            for (i = 0; i < QtdIndicadores; i++)
               Indicadores1 += "                   <option value=\""+ Ag.m_IndicadoresDesempenho.elementAt(i).toString() +"\">" + Ag.m_IndicadoresDesempenho.elementAt(i).toString() + "</option>\n";
...
//            Indicadores2 += "                   <option value=\""+ Ag.m_vIndicadores.elementAt(i).toString() +"\">" + Ag.m_vIndicadores.elementAt(i).toString() + "</option>\n";
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDesempenho:apresentaIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaConfiguracao() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDesempenho:apresentaConfiguracao(): "+ Exc);
         Exc.printStackTrace();
      }    
   }
   ...
   public void apresentaRelatorioFinal() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDesempenho:apresentaRelatorioFinal(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaSelecaoDePaginas() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDesempenho:apresentaSelecaoDePaginas(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void apresentaLogs()
   {
      try
      {
         ...
         m_Args[2] = Cabecalho;
         if (Ag.m_NomesDatas != null) 
        	 m_Args[3] = Ag.m_NomesDatas.elementAt(Ag.m_UltProcessado).toString();
         else 
        	 m_Args[3] = Ag.m_Datas.elementAt(Ag.m_UltProcessado).toString();
         m_Args[4] = Logs;         
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDesempenho:apresentaLogs(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
...
//               Indicadores = Ag.m_vIndicadores.elementAt(0).toString()+";"+ Ag.m_vIndicadores.elementAt(1).toString()+";"+Indicadores;
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDesempenho:alteraIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void alteraConfiguracao() 
   {
      ...
      if (Usuario != null)
      {
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDesempenho:alteraConfiguracao(): Usuario nao foi encontrado");
   }
...
*/      
   ...
   public void home() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDesempenho:home(): "+ Exc);
         Exc.printStackTrace();
      }
   }  
...
//         vCabecalho = new Vector (Ag.m_Cabecalho);
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDesempenho:download(): "+ Exc);
         Exc.printStackTrace();         
      }
   }
   ...
   public static synchronized void removeAgenda(OpApresentaRelAgendadoDesempenho p_Operacao)
   {
      try
      {
         AgendaDesempenho Ag = null;
         ...
         s_MapAgendasDesempenho.remove(p_Operacao.m_KeyCache);
      }
      catch (Exception Exc)
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDesempenho:removeAgenda(): Nao foi possivel remvoer a agenda com chave: "+p_Operacao.m_KeyCache);
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDesempenho:removeAgenda(): "+ Exc);
         Exc.printStackTrace();
      }
   }

   public AgendaDesempenho buscaAgenda() 
   {
   ...
   public static synchronized AgendaDesempenho buscaAgenda(OpApresentaRelAgendadoDesempenho p_Operacao)
   {
      Object ObjAg = null;
      AgendaDesempenho Ag = null;
      
      if (s_MapAgendasDesempenho.size() == 0)
      {
         Ag = p_Operacao.criaAgenda();
         return Ag;
      }

      ObjAg = s_MapAgendasDesempenho.get(p_Operacao.m_KeyCache);
      if (ObjAg != null)
      {
         Ag = (AgendaDesempenho)ObjAg;
      }
      else
      {
         Ag = p_Operacao.criaAgenda();
   ...
   public void insereAgenda(AgendaDesempenho p_Agenda) 
   {
      synchronized(s_MapAgendasDesempenho)
      {
         s_MapAgendasDesempenho.put(m_KeyCache, p_Agenda);
      }      
   }

   public AgendaDesempenho criaAgenda() 
   {
      boolean Retorno;
      AgendaDesempenho Ag;
      UsuarioDef Usuario = (UsuarioDef)NoUtil.getUsuarioLogado(m_Request.getSession().getId());
      ...
      Ag = new AgendaDesempenho(no.getConexaoServUtil(), 
                                m_Perfil, 
                                m_TipoRelatorio, 
                                m_IdRelatorio, 
                                m_NomeArquivoRelatorio, 
                                m_SelecaoRecursosDesempenho, 
                                m_SelecaoIndicadorDesempenho,
                                m_IndicadoresDesempenho,
                                m_NomeRelatorio,
                                m_DataGeracao);
      m_Agenda = Ag;
...
class DownloadRelAgendadoDesempenho extends java.lang.Thread
   {
	 ...
	 */
	AgendaDesempenho m_Ag = null;

      String m_NomeArq;      
      Vector m_vCabecalho;
      Vector m_CfgWeb;

      public DownloadRelAgendadoDesempenho(String p_NomeArq, Vector p_vCabecalho, AgendaDesempenho p_Ag, Vector p_CfgWeb)
      {
         m_Ag = p_Ag;
         m_NomeArq = p_NomeArq;
