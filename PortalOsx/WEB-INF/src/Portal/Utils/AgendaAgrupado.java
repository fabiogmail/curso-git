...
public class AgendaAgrupado extends Agenda
{
   //public String[] m_Rec = null;
   public  Vector m_Recv = null;
   private String m_Indicadores;
   public Vector m_RelatoriosProcessados[] = null;
   public Vector m_IndicadoresAgrupado;
   
   public AgendaAgrupado(CnxServUtil p_ConexUtil, String p_Perfil, String p_TipoRel, String p_IdRel, String p_Arquivo, SelecaoRecursosAgrupado p_SelecaoRecursosAgrupado, SelecaoIndicadorAgrupado p_SelecaoIndicadorAgrupado, String p_IndicadoresAgrupado, String p_NomeRel, String p_DataGer)
   {
      super(p_ConexUtil, p_Perfil, p_TipoRel, p_IdRel, p_Arquivo, p_NomeRel, p_DataGer);

      this.setM_SelecaoRecursos(p_SelecaoRecursosAgrupado);
      this.setM_SelecaoIndicador(p_SelecaoIndicadorAgrupado);
      this.setM_ContadoresRelatorio(m_iRetRelatorio.fnGetContadores());
      
      m_IndicadoresAgrupado = VetorUtil.String2Vetor(p_IndicadoresAgrupado, ';');
