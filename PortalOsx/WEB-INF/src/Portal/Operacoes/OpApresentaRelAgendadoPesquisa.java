...
import Portal.Utils.AgendaPesquisa;
...
/**
 */
public class OpApresentaRelAgendadoPesquisa extends OperacaoAbs 
{
   ...
   public OpApresentaRelAgendadoPesquisa() 
   {
   }
   ...
   {     
      ...
      if (m_SubOperacao.toLowerCase().equals("paginicial"))
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisa:iniciaOperacao() - Suboperacao nao encontrada: "+ m_SubOperacao);
      return true;
   }
   ...
   public void apresentaPagInicial() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisa:apresentaPagInicial(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaPagInicial2() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisa:apresentaPagInicial2(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisa:apresentaRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaTopoRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisa:apresentaTopoRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
...
*/
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisa:apresentaMeioRelatorios(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaBaseRelatorio()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisa:apresentaBaseRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaIndicadores()
   {
      try
      {
         ...
         {
            QtdIndicadores = Ag.m_IndicadoresPesquisa.size();
            for (i = 0; i < QtdIndicadores; i++)
               Indicadores1 += "                   <option value=\""+ Ag.m_IndicadoresPesquisa.elementAt(i).toString() +"\">" + Ag.m_IndicadoresPesquisa.elementAt(i).toString() + "</option>\n";
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisa:apresentaIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaConfiguracao() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisa:apresentaConfiguracao(): "+ Exc);
         Exc.printStackTrace();
      }    
   }
   ...
   public void apresentaRelatorioFinal() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisa:apresentaRelatorioFinal(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaSelecaoDePaginas() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisa:apresentaSelecaoDePaginas(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void apresentaLogs()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisa:apresentaLogs(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void alteraIndicadores()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisa:alteraIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void alteraConfiguracao() 
   {
      ...
      if (Usuario != null)
      {
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisa:alteraConfiguracao(): Usuario nao foi encontrado");
   }
...
*/      
   ...
   public void home() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisa:home(): "+ Exc);
         Exc.printStackTrace();
      }
   }  
   ...
   public static synchronized void removeAgenda(OpApresentaRelAgendadoPesquisa p_Operacao)
   {
      try
      {
         AgendaPesquisa Ag = null;
         ...
         s_MapAgendasPesquisa.remove(p_Operacao.m_KeyCache);
      }
      catch (Exception Exc)
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisa:removeAgenda(): Nao foi possivel remvoer a agenda com chave: "+p_Operacao.m_KeyCache);
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisa:removeAgenda(): "+ Exc);
      }
   }

   public AgendaPesquisa buscaAgenda() 
   {
   ...
   public static synchronized AgendaPesquisa buscaAgenda(OpApresentaRelAgendadoPesquisa p_Operacao)
   {
      Object ObjAg = null;
      AgendaPesquisa Ag = null;
      
      if (s_MapAgendasPesquisa.size() == 0)
      {
         Ag = p_Operacao.criaAgenda();
         return Ag;
      }

      ObjAg = s_MapAgendasPesquisa.get(p_Operacao.m_KeyCache);
      if (ObjAg != null)
      {
         Ag = (AgendaPesquisa)ObjAg;
      }
      else
      {
         Ag = p_Operacao.criaAgenda();
   ...
   public void insereAgenda(AgendaPesquisa p_Agenda) 
   {
      synchronized(s_MapAgendasPesquisa)
      {
         s_MapAgendasPesquisa.put(m_KeyCache, p_Agenda);
      }
   }

   public AgendaPesquisa criaAgenda() 
   {
      boolean Retorno;
      AgendaPesquisa Ag;
      UsuarioDef Usuario = (UsuarioDef)NoUtil.getUsuarioLogado(m_Request.getSession().getId());
      ...
      Ag = new AgendaPesquisa(no.getConexaoServUtil(), 
                              m_Perfil, 
                              m_TipoRelatorio, 
                              m_IdRelatorio, 
                              m_NomeArquivoRelatorio, 
                              m_SelecaoRecursosPesquisa, 
                              m_SelecaoIndicadorPesquisa, 
                              m_IndicadoresPesquisa,
                              m_NomeRelatorio,
                              m_DataGeracao);
...
class DownloadRelAgendadoPesquisa extends java.lang.Thread
   {
	 ...
	 */
	AgendaPesquisa m_Ag = null;

      String m_NomeArq;      
      Vector m_vCabecalho;
      Vector m_CfgWeb;      

      public DownloadRelAgendadoPesquisa(String p_NomeArq, Vector p_vCabecalho, AgendaPesquisa p_Ag, Vector p_CfgWeb)
      {
         m_Ag = p_Ag;
         m_NomeArq = p_NomeArq;
