...
import Portal.Utils.AgendaDestinosComuns;
...
/**
 */
public class OpApresentaRelAgendadoDestinosComuns extends OperacaoAbs 
{
   ...
   public OpApresentaRelAgendadoDestinosComuns() 
   {
   }
   ...
   {     
      ...
      if (m_SubOperacao.toLowerCase().equals("paginicial"))
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosComuns:iniciaOperacao() - Suboperacao nao encontrada: "+ m_SubOperacao);
      return true;
   }
   ...
   public void apresentaPagInicial() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosComuns:apresentaPagInicial(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaPagInicial2() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosComuns:apresentaPagInicial2(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosComuns:apresentaRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaTopoRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosComuns:apresentaTopoRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
...
*/
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosComuns:apresentaMeioRelatorios(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaBaseRelatorio()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosComuns:apresentaBaseRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaIndicadores()
   {
      try
      {
         ...
         {
            QtdIndicadores = Ag.m_IndicadoresDestinosComuns.size();
            for (i = 0; i < QtdIndicadores; i++)
               Indicadores1 += "                   <option value=\""+ Ag.m_IndicadoresDestinosComuns.elementAt(i).toString() +"\">" + Ag.m_IndicadoresDestinosComuns.elementAt(i).toString() + "</option>\n";
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosComuns:apresentaIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaConfiguracao() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosComuns:apresentaConfiguracao(): "+ Exc);
         Exc.printStackTrace();
      }    
   }
   ...
   public void apresentaRelatorioFinal() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosComuns:apresentaRelatorioFinal(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaSelecaoDePaginas() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosComuns:apresentaSelecaoDePaginas(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void apresentaLogs()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosComuns:apresentaLogs(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void alteraIndicadores()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosComuns:alteraIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void alteraConfiguracao() 
   {
      ...
      if (Usuario != null)
      {
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosComuns:alteraConfiguracao(): Usuario nao foi encontrado");
   }
...
/*   
      ...
      {
         System.out.println(m_ConexUtil.getDataHoraAtual() + " OpApresentaRelAgendadoDestinosComuns:ordena(): "+ Exc);
         Exc.printStackTrace();
      }
*/      
   }
   ...
   public void home() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosComuns:home(): "+ Exc);
         Exc.printStackTrace();
      }
   }  
   ...
   public void download()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosComuns:download(): "+ Exc);
         Exc.printStackTrace();         
      }
   }
   ...
   public static synchronized void removeAgenda(OpApresentaRelAgendadoDestinosComuns p_Operacao)
   {
      try
      {
         AgendaDestinosComuns Ag = null;
         ...
         s_MapAgendasDestinosComuns.remove(p_Operacao.m_KeyCache);
      }
      catch (Exception Exc)
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosComuns:removeAgenda(): Nao foi possivel remvoer a agenda com chave: "+p_Operacao.m_KeyCache);
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosComuns:removeAgenda(): "+ Exc);
      }
   }

   public AgendaDestinosComuns buscaAgenda() 
   {
   ...
   public static synchronized AgendaDestinosComuns buscaAgenda(OpApresentaRelAgendadoDestinosComuns p_Operacao)
   {
      Object ObjAg = null;
      AgendaDestinosComuns Ag = null;
      
      if (s_MapAgendasDestinosComuns.size() == 0)
      {
         Ag = p_Operacao.criaAgenda();
         return Ag;
      }

      ObjAg = s_MapAgendasDestinosComuns.get(p_Operacao.m_KeyCache);
      if (ObjAg != null)
      {
         Ag = (AgendaDestinosComuns)ObjAg;
      }
      else
      {
         Ag = p_Operacao.criaAgenda();
   ...
   public void insereAgenda(AgendaDestinosComuns p_Agenda) 
   {
      synchronized(s_MapAgendasDestinosComuns)
      {
         s_MapAgendasDestinosComuns.put(m_KeyCache, p_Agenda);
      }
   }

   public AgendaDestinosComuns criaAgenda() 
   {
      boolean Retorno;
      AgendaDestinosComuns Ag;
      UsuarioDef Usuario = (UsuarioDef)NoUtil.getUsuarioLogado(m_Request.getSession().getId());
      ...
      Ag = new AgendaDestinosComuns(no.getConexaoServUtil(), 
                              m_Perfil, 
                              m_TipoRelatorio, 
                              m_IdRelatorio, 
                              m_NomeArquivoRelatorio, 
                              m_SelecaoRecursosDestinosComuns, 
                              m_SelecaoIndicadorDestinosComuns, 
                              m_IndicadoresDestinosComuns,
                              m_NomeRelatorio,
                              m_DataGeracao);
...
class DownloadRelAgendadoDestinosComuns extends java.lang.Thread
   {
	 ...
	 */
	AgendaDestinosComuns m_Ag = null;

      String m_NomeArq;      
      Vector m_vCabecalho;
      Vector m_CfgWeb;      

      public DownloadRelAgendadoDestinosComuns(String p_NomeArq, Vector p_vCabecalho, AgendaDestinosComuns p_Ag, Vector p_CfgWeb)
      {
         m_Ag = p_Ag;
         m_NomeArq = p_NomeArq;
