...
public class AgendaDesempenho extends Agenda
{
   //public String[] m_Rec = null;
   public  Vector m_Recv = null;
   private String m_Indicadores;
   public Vector m_RelatoriosProcessados[] = null;
   public Vector m_IndicadoresDesempenho;
   
   public AgendaDesempenho(CnxServUtil p_ConexUtil, String p_Perfil, String p_TipoRel, String p_IdRel, String p_Arquivo, SelecaoRecursosDesempenho p_SelecaoRecursosDesempenho, SelecaoIndicadorDesempenho p_SelecaoIndicadorDesempenho, String p_IndicadoresDesempenho, String p_NomeRel, String p_DataGer)
   {
      super(p_ConexUtil, p_Perfil, p_TipoRel, p_IdRel, p_Arquivo, p_NomeRel, p_DataGer);

      this.setM_SelecaoRecursos(p_SelecaoRecursosDesempenho);
      this.setM_SelecaoIndicador(p_SelecaoIndicadorDesempenho);
      this.setM_ContadoresRelatorio(m_iRetRelatorio.fnGetContadores());
      
      m_IndicadoresDesempenho = VetorUtil.String2Vetor(p_IndicadoresDesempenho, ';');
