...
/**
 */
public class OpApresentaRelAgendadoGRE extends OperacaoAbs 
{
...
*/         
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoGRE:iniciaOperacao() - Suboperacao nao encontrada: "+ m_SubOperacao);
   ...
   public void apresentaPagInicial() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoGRE:apresentaPagInicial(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaPagInicial2() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoGRE:apresentaPagInicial2(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoGRE:apresentaRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaTopoRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoGRE:apresentaTopoRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaMeioRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoGRE:apresentaMeioRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaBaseRelatorio()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoGRE:apresentaBaseRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaIndicadores()
   {
      try
      {
         ...
         {
            QtdIndicadores = Ag.m_IndicadoresGRE.size();            
            for (i = 0; i < QtdIndicadores; i++)
               Indicadores1 += "                   <option value=\""+ Ag.m_IndicadoresGRE.elementAt(i).toString() +"\">" + Ag.m_IndicadoresGRE.elementAt(i).toString() + "</option>\n";
...
//            Indicadores2 += "                   <option value=\""+ Ag.m_vIndicadores.elementAt(i).toString() +"\">" + Ag.m_vIndicadores.elementAt(i).toString() + "</option>\n";
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoGRE:apresentaIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaConfiguracao() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoGRE:apresentaConfiguracao(): "+ Exc);
         Exc.printStackTrace();
      }    
   }
   ...
   public void apresentaRelatorioFinal() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoGRE:apresentaRelatorioFinal(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaSelecaoDePaginas() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoGRE:apresentaSelecaoDePaginas(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void apresentaLogs()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoGRE:apresentaLogs(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
...
//               Indicadores = Ag.m_vIndicadores.elementAt(0).toString()+";"+ Ag.m_vIndicadores.elementAt(1).toString()+";"+Indicadores;
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoGRE:alteraIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void alteraConfiguracao() 
   {
      ...
      if (Usuario != null)
      {
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoGRE:alteraConfiguracao(): Usuario nao foi encontrado");
   }
...
/*   
      ...
      {
         System.out.println(m_ConexUtil.getDataHoraAtual() + " OpApresentaRelAgendadoGRE:ordena(): "+ Exc);
         Exc.printStackTrace();
      }
*/      
   }
   ...
   public void home() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoGRE:home(): "+ Exc);
         Exc.printStackTrace();
      }
   }  
...
//         vCabecalho = new Vector (Ag.m_Cabecalho);
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoGRE:download(): "+ Exc);
         Exc.printStackTrace();         
      }
   }
   ...
   public static synchronized void removeAgenda(OpApresentaRelAgendadoGRE p_Operacao)
   {
      try
      {
         AgendaGRE Ag = null;
         ...
         s_MapAgendasGRE.remove(p_Operacao.m_KeyCache);
      }
      catch (Exception Exc)
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoGRE:removeAgenda(): Nao foi possivel remvoer a agenda com chave: "+p_Operacao.m_KeyCache);
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoGRE:removeAgenda(): "+ Exc);
         Exc.printStackTrace();
      }
   }

   public AgendaGRE buscaAgenda() 
   {
   ...
   public static synchronized AgendaGRE buscaAgenda(OpApresentaRelAgendadoGRE p_Operacao)
   {
      Object ObjAg = null;
      AgendaGRE Ag = null;
      
      if (s_MapAgendasGRE.size() == 0)
      {
         Ag = p_Operacao.criaAgenda();
         return Ag;
      }

      ObjAg = s_MapAgendasGRE.get(p_Operacao.m_KeyCache);
      if (ObjAg != null)
      {
         Ag = (AgendaGRE)ObjAg;
      }
   ...
   public void insereAgenda(AgendaGRE p_Agenda) 
   {
      synchronized(s_MapAgendasGRE)
      {
         s_MapAgendasGRE.put(m_KeyCache, p_Agenda);
      }      
   }

   public AgendaGRE criaAgenda() 
   {
      boolean Retorno;
      AgendaGRE Ag;
      UsuarioDef Usuario = (UsuarioDef)NoUtil.getUsuarioLogado(m_Request.getSession().getId());
      ...
      Ag = new AgendaGRE(no.getConexaoServUtil(), 
                                m_Perfil, 
                                m_TipoRelatorio, 
                                m_IdRelatorio, 
                                m_NomeArquivoRelatorio, 
                                m_SelecaoRecursosGRE, 
                                m_SelecaoIndicadorGRE,
                                m_IndicadoresGRE,
                                m_NomeRelatorio,
                                m_DataGeracao);
      m_Agenda = Ag;
...
class DownloadRelAgendadoGRE extends java.lang.Thread
   {
	...
	AgendaGRE m_Ag = null;
      ...
      public DownloadRelAgendadoGRE(String p_NomeArq, Vector p_vCabecalho, AgendaGRE p_Ag, Vector p_CfgWeb)
      {
         m_Ag = p_Ag;
         m_NomeArq = p_NomeArq;
