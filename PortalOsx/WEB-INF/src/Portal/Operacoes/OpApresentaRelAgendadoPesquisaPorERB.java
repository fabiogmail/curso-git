//Source file: C:/usr/osx/CDRView/Servlet/Portal/Operacoes/OpApresentaRelAgendadoPesquisaPorERB.java
...
import Portal.Utils.AgendaPesquisaPorERB;
...
/**
 */
public class OpApresentaRelAgendadoPesquisaPorERB extends OperacaoAbs 
{
   ...
   public OpApresentaRelAgendadoPesquisaPorERB() 
   {
   }
   ...
   {     
      ...
      if (m_SubOperacao.toLowerCase().equals("paginicial"))
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaPorERB:iniciaOperacao() - Suboperacao nao encontrada: "+ m_SubOperacao);
      return true;
   }
   ...
   public void apresentaPagInicial() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaPorERB:apresentaPagInicial(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaPagInicial2() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaPorERB:apresentaPagInicial2(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaPorERB:apresentaRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaTopoRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaPorERB:apresentaTopoRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
...
*/
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaPorERB:apresentaMeioRelatorios(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaBaseRelatorio()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaPorERB:apresentaBaseRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaIndicadores()
   {
      try
      {
         ...
         {
            QtdIndicadores = Ag.m_IndicadoresPesquisaPorERB.size();
            for (i = 0; i < QtdIndicadores; i++)
               Indicadores1 += "                   <option value=\""+ Ag.m_IndicadoresPesquisaPorERB.elementAt(i).toString() +"\">" + Ag.m_IndicadoresPesquisaPorERB.elementAt(i).toString() + "</option>\n";
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaPorERB:apresentaIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaConfiguracao() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaPorERB:apresentaConfiguracao(): "+ Exc);
         Exc.printStackTrace();
      }    
   }
   ...
   public void apresentaRelatorioFinal() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaPorERB:apresentaRelatorioFinal(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaSelecaoDePaginas() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaPorERB:apresentaSelecaoDePaginas(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void apresentaLogs()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaPorERB:apresentaLogs(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void alteraIndicadores()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaPorERB:alteraIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void alteraConfiguracao() 
   {
      ...
      if (Usuario != null)
      {
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaPorERB:alteraConfiguracao(): Usuario nao foi encontrado");
   }
...
/*   
      ...
      {
         System.out.println(m_ConexUtil.getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaPorERB:ordena(): "+ Exc);
         Exc.printStackTrace();
      }
*/      
   }
   ...
   public void home() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaPorERB:home(): "+ Exc);
         Exc.printStackTrace();
      }
   }  
   ...
   public void download()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaPorERB:download(): "+ Exc);
         Exc.printStackTrace();         
      }
   }
   ...
   public static synchronized void removeAgenda(OpApresentaRelAgendadoPesquisaPorERB p_Operacao)
   {
      try
      {
         AgendaPesquisaPorERB Ag = null;
         ...
         s_MapAgendasPesquisaPorERB.remove(p_Operacao.m_KeyCache);
      }
      catch (Exception Exc)
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaPorERB:removeAgenda(): Nao foi possivel remvoer a agenda com chave: "+p_Operacao.m_KeyCache);
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaPorERB:removeAgenda(): "+ Exc);
      }
   }

   public AgendaPesquisaPorERB buscaAgenda() 
   {
   ...
   public static synchronized AgendaPesquisaPorERB buscaAgenda(OpApresentaRelAgendadoPesquisaPorERB p_Operacao)
   {
      Object ObjAg = null;
      AgendaPesquisaPorERB Ag = null;
      
      if (s_MapAgendasPesquisaPorERB.size() == 0)
      {
         Ag = p_Operacao.criaAgenda();
         return Ag;
      }

      ObjAg = s_MapAgendasPesquisaPorERB.get(p_Operacao.m_KeyCache);
      if (ObjAg != null)
      {
         Ag = (AgendaPesquisaPorERB)ObjAg;
      }
      else
      {
         Ag = p_Operacao.criaAgenda();
   ...
   public void insereAgenda(AgendaPesquisaPorERB p_Agenda) 
   {
      synchronized(s_MapAgendasPesquisaPorERB)
      {
         s_MapAgendasPesquisaPorERB.put(m_KeyCache, p_Agenda);
      }
   }

   public AgendaPesquisaPorERB criaAgenda() 
   {
      boolean Retorno;
      AgendaPesquisaPorERB Ag;
      UsuarioDef Usuario = (UsuarioDef)NoUtil.getUsuarioLogado(m_Request.getSession().getId());
      ...
      Ag = new AgendaPesquisaPorERB(no.getConexaoServUtil(), 
                              m_Perfil, 
                              m_TipoRelatorio, 
                              m_IdRelatorio, 
                              m_NomeArquivoRelatorio, 
                              m_SelecaoRecursosPesquisaPorERB, 
                              m_SelecaoIndicadorPesquisaPorERB, 
                              m_IndicadoresPesquisaPorERB,
                              m_NomeRelatorio,
                              m_DataGeracao);
...
class DownloadRelAgendadoPesquisaPorERB extends java.lang.Thread
   {
	 ...
	 */
	AgendaPesquisaPorERB m_Ag = null;

      String m_NomeArq;      
      Vector m_vCabecalho;
      Vector m_CfgWeb;      

      public DownloadRelAgendadoPesquisaPorERB(String p_NomeArq, Vector p_vCabecalho, AgendaPesquisaPorERB p_Ag, Vector p_CfgWeb)
      {
         m_Ag = p_Ag;
         m_NomeArq = p_NomeArq;
