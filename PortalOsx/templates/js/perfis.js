...
function Inclui()
{
	...
	var tam = document.form1.ListaRelatoriosPermitidos.length;
	if (tam == 0 && document.form1.tipoEscolhaRel[0].checked == false)
	{
		alert ("E necessario associar o perfil a um relatorio!");
		return false;
	}
...
function AdicionaPermissaoRel()
{
   ...
   {
      alert("Selecione um relatório para alterar sua permissão");
      return;
   }
