...
public class OpDetalhaExportadoDrill extends OperacaoAbs{
	    ...
	    */
	   public OpDetalhaExportadoDrill()
	   {
	   }
	   ...
	   public String[] montaFormulario() 
	   {
	      ...
	      for (Iterator iter = NoUtil.listaDeNos.iterator(); iter.hasNext();)
	      {
	          try
	          {
		          ...
		          iPerfil perfilServ = noTmp.getConexaoServUtil().getM_iListaPerfis().fnPerfilExiste(nomePerfil);
		          
		          if (perfilServ != null)
		          {
		              Linhas = noTmp.getConexaoServUtil().getRelatorioExpHeaderDrill(Perfil,Arquivo);
		              break;
		          }
	          } 
