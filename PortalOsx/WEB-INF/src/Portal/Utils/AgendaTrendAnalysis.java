...
public class AgendaTrendAnalysis extends Agenda
{
   //public String[] m_Rec = null;
   public  Vector m_Recv = null;
   private String m_Indicadores;
   public Vector m_RelatoriosProcessados[] = null;
   public Vector m_IndicadoresTrendAnalysis;
   
   public AgendaTrendAnalysis(CnxServUtil p_ConexUtil, String p_Perfil, String p_TipoRel, String p_IdRel, String p_Arquivo, SelecaoRecursosTrendAnalysis p_SelecaoRecursosTrendAnalysis, SelecaoIndicadorTrendAnalysis p_SelecaoIndicadorTrendAnalysis, String p_IndicadoresTrendAnalysis, String p_NomeRel, String p_DataGer)
   {
      super(p_ConexUtil, p_Perfil, p_TipoRel, p_IdRel, p_Arquivo, p_NomeRel, p_DataGer);

      this.setM_SelecaoRecursos(p_SelecaoRecursosTrendAnalysis);
      this.setM_SelecaoIndicador(p_SelecaoIndicadorTrendAnalysis);
      this.setM_ContadoresRelatorio(m_iRetRelatorio.fnGetContadores());
      
      m_IndicadoresTrendAnalysis = VetorUtil.String2Vetor(p_IndicadoresTrendAnalysis, ';');
