...
/**
 */
public class OpGerenciaParsers extends OperacaoAbs 
{
   ...
   public boolean iniciaOperacao(String p_Mensagem) 
   {
      ...
      try
      {
         ...
         m_Args[2] = "src=\"/PortalOsx/templates/js/gerenciaparsers.js\"";
         m_Args[3] = "onLoad=\"Processa(0)\"";
         m_Args[4] = "parsersgerenciamento.gif";
         m_Args[5] = m_Html.criaFormulario(NoUtil.getNo().getDiretorioDefs().getS_DIR_TMPL_FORMS(), "gerenciaparsers.form", montaFormulario(p_Mensagem));
   ...
   public String[] montaFormulario(String p_Mensagem) 
   {
      ...
      try{
          if((DefsComum.s_CLIENTE.equalsIgnoreCase("tim")) || (DefsComum.s_CLIENTE.equalsIgnoreCase("oi")
