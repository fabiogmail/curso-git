...
/**
 */
public class OpListaCfgConversores extends OperacaoAbs 
{
   ...
   public boolean iniciaOperacao(String p_Mensagem) 
   {
      try
      {
         setOperacao("Lista Configuração de Conversores");
         montaTabela();
         m_Args = new String[7];
         ...
         m_Args[2] = ""; // javascript
         m_Args[3] = ""; // onload
         m_Args[4] = "listacfgconversores.gif";
         m_Args[5] = m_Html.m_Tabela.getTabelaString();
         m_Args[6] = m_Html.leFormulario(NoUtil.getNo().getDiretorioDefs().getS_DIR_TMPL_TXT(), "listaconversorescfg.txt", null);
         m_Html.enviaArquivo(m_Args);
         return true;
      }
      catch (Exception Exc)
      {
         System.out.println("OpListaCfgConversores - iniciaOperacao(): "+Exc);
         Exc.printStackTrace();
         return false;
      }
   }
   ...
   public void montaTabela() 
   {
      ...
      String Header[] = {"Configura&ccedil;&atilde;o", "Servidor", "Conversor", "Bilhetadores"};
      ...
      m_Html.m_Tabela.setLink("/PortalOsx/servlet/Portal.cPortal?operacao=listaCfgConversores&tipo="+Tipo);
