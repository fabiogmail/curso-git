...
public class AgendaPesquisaPorERB extends Agenda
{
   ...
   public Vector m_IndicadoresPesquisaPorERB;   

   
   public AgendaPesquisaPorERB(CnxServUtil p_ConexUtil, String p_Perfil, String p_TipoRel, String p_IdRel, String p_Arquivo, SelecaoRecursosPesquisaPorERB p_SelecaoRecursosPesquisaPorERB, SelecaoIndicadorPesquisaPorERB p_SelecaoIndicadorPesquisaPorERB, String p_IndicadoresPesquisaPorERB, String p_NomeRel, String p_DataGer)
   {
...
//      this.setM_SelecaoRecursos(p_SelecaoRecursosPesquisa);
      this.setM_SelecaoIndicador(p_SelecaoIndicadorPesquisaPorERB);
      this.setM_ContadoresRelatorio(m_iRetRelatorio.fnGetContadores());

      m_IndicadoresPesquisaPorERB = VetorUtil.String2Vetor(p_IndicadoresPesquisaPorERB, ';');
