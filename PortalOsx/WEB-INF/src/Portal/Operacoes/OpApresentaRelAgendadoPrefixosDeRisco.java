//Source file: C:/usr/osx/CDRView/Servlet/Portal/Operacoes/OpApresentaRelAgendadoPrefixosFixo.java
...
import Portal.Utils.AgendaPrefixosDeRisco;
...
public class OpApresentaRelAgendadoPrefixosDeRisco extends OperacaoAbs 
{
   ...
   public OpApresentaRelAgendadoPrefixosDeRisco() 
   {
   ...
   {     
      ...
      if (m_SubOperacao.toLowerCase().equals("paginicial"))
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPrefixosDeRisco:iniciaOperacao() - Suboperacao nao encontrada: "+ m_SubOperacao);
      return true;
   }
   ...
   public void apresentaPagInicial() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPrefixosDeRisco:apresentaPagInicial(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaPagInicial2() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPrefixosDeRisco:apresentaPagInicial2(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPrefixosDeRisco:apresentaRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaTopoRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPrefixosDeRisco:apresentaTopoRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaMeioRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPrefixosDeRisco:apresentaMeioRelatorios(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaBaseRelatorio()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPrefixosDeRisco:apresentaBaseRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaIndicadores()
   {
      try
      {
         ...
         {
            QtdIndicadores = Ag.m_IndicadoresPrefixosDeRisco.size();
            for (i = 0; i < QtdIndicadores; i++)
               Indicadores1 += "                   <option value=\""+ Ag.m_IndicadoresPrefixosDeRisco.elementAt(i).toString() +"\">" + Ag.m_IndicadoresPrefixosDeRisco.elementAt(i).toString() + "</option>\n";
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPrefixosDeRisco:apresentaIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaConfiguracao() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPrefixosDeRisco:apresentaConfiguracao(): "+ Exc);
         Exc.printStackTrace();
      }    
   }
   ...
   public void apresentaRelatorioFinal() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPrefixosDeRisco:apresentaRelatorioFinal(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaSelecaoDePaginas() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPrefixosDeRisco:apresentaSelecaoDePaginas(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void apresentaLogs()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPrefixosDeRisco:apresentaLogs(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void alteraIndicadores()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPrefixosDeRisco:alteraIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
...
*/
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPrefixosDeRisco:alteraConfiguracao(): Usuario nao foi encontrado");
   }
...
/*   
      ...
      {
         System.out.println(m_ConexUtil.getDataHoraAtual() + " OpApresentaRelAgendadoPrefixosDeRisco:ordena(): "+ Exc);
         Exc.printStackTrace();
      }
*/      
   }
   ...
   public void home() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPrefixosDeRisco:home(): "+ Exc);
         Exc.printStackTrace();
      }
   }  
   ...
   public void download()
   {
      try
      {
         ...
         switch (Ag.getStatusArqDownload())
         {
            ...
            case Agenda.STATUS_DOWNLOAD_MONTANDO_ARQ:
				...
				//Ag.getLinhasAposCabecalho();
				//Ag.remontaRelatorios(Short.parseShort(m_TipoRelatorio));
	            //new DownloadRelAgendadoPrefixosDeRisco(NomeArq, vCabecalho, Ag, UsuarioAux.getConfWebAgenda());
	            //Thread.sleep(1000);
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPrefixosDeRisco:download(): "+ Exc);
         Exc.printStackTrace();         
      }
   }
   ...
   public static synchronized void removeAgenda(OpApresentaRelAgendadoPrefixosDeRisco p_Operacao)
   {
      try
      {
         AgendaPrefixosDeRisco Ag = null;
         ...
         s_MapAgendasPrefixosDeRisco.remove(p_Operacao.m_KeyCache);
      }
      catch (Exception Exc)
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPrefixosRisco:removeAgenda(): Nao foi possivel remvoer a agenda com chave: "+p_Operacao.m_KeyCache);
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPrefixosRisco:removeAgenda(): "+ Exc);
         Exc.printStackTrace();
      }
   }

   public AgendaPrefixosDeRisco buscaAgenda() 
   {
   ...
   public static synchronized AgendaPrefixosDeRisco buscaAgenda(OpApresentaRelAgendadoPrefixosDeRisco p_Operacao)
   {
      Object ObjAg = null;
      AgendaPrefixosDeRisco Ag = null;    
      
      if (s_MapAgendasPrefixosDeRisco.size() == 0)
      {
         Ag = p_Operacao.criaAgenda();
         return Ag;
      }

      ObjAg = s_MapAgendasPrefixosDeRisco.get(p_Operacao.m_KeyCache);
      if (ObjAg != null)
      {
         Ag = (AgendaPrefixosDeRisco)ObjAg;
      }
      else
      {
         Ag = p_Operacao.criaAgenda();
   ...
   public void insereAgenda(AgendaPrefixosDeRisco p_Agenda) 
   {
      synchronized(s_MapAgendasPrefixosDeRisco)
      {
         s_MapAgendasPrefixosDeRisco.put(m_KeyCache, p_Agenda);
      }   
   }

   public AgendaPrefixosDeRisco criaAgenda() 
   {
      boolean Retorno;
      AgendaPrefixosDeRisco Ag;
      UsuarioDef Usuario = (UsuarioDef)NoUtil.getUsuarioLogado(m_Request.getSession().getId());
      ...
      Ag = new AgendaPrefixosDeRisco(no.getConexaoServUtil(), 
	                                 m_Perfil, 
	                                 m_TipoRelatorio, 
	                                 m_IdRelatorio, 
	                                 m_NomeArquivoRelatorio, 
	                                 m_SelecaoIndicadorPrefixosDeRisco, 
	                                 m_IndicadoresPrefixosDeRisco,
	                                 m_NomeRelatorio,
	                                 m_DataGeracao);
...
class DownloadRelAgendadoPrefixosDeRisco extends java.lang.Thread
   {
	 ...
	 */
	AgendaPrefixosDeRisco m_Ag = null;

      String m_NomeArq;      
      Vector m_vCabecalho;
      Vector m_CfgWeb;

      public DownloadRelAgendadoPrefixosDeRisco(String p_NomeArq, Vector p_vCabecalho, AgendaPrefixosDeRisco p_Ag, Vector p_CfgWeb)
      {
         m_Ag = p_Ag;
         m_NomeArq = p_NomeArq;
