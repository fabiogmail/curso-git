...
function SelecionaConfiguracao()
{
	...
	if (Indice != -1)
	{
		...
		{
			//alert (aListaRelac[Indice][2] +" - "+ document.form1.ListaConversores.options[i].text);
			if (aListaRelac[Indice][2] == document.form1.ListaConversores.options[i].text)
			{
				document.form1.ListaConversores.selectedIndex = i;
				//alert (document.form1.ListaConversores.options[i].text);
				break;
			}
		}
...
function VerificaCampo(NomeDoCampo, ValorDoCampo, TamMinimo, TamMaximo)
{
   ...
   if (ValorDoCampo.substring(0,2) != "c_")
      return NomeDoCampo + " deve iniciar com \'c_\'!";
...
function Inclui(Operacao)
{
	...
	{	
		...
		Indice = document.form1.ListaConversores.selectedIndex;
		if (Indice == -1)
		{
		...
		if (Operacao == "inclusao")
		{
			...
			document.form2.conversor.value = document.form1.ListaConversores.options[document.form1.ListaConversores.selectedIndex].text;
		...
		else
		{
			...
			document.form4.conversor.value = document.form1.ListaConversores.options[document.form1.ListaConversores.selectedIndex].text;
...
function Exclui()
{
	...
	{
		alert ("Selecione uma configuração para apagar!");
		return false;
	}
}