...
function Inicia()
{
   if (document.form1.ListaConfiguracoes.length == 0)
	{
		alert ("Não há configurações de reprocessadores para iniciar!");
		return false;
	}
   ...
   if (Indice == -1)
	{
		alert ("Selecione uma configuração de reprocessador para iniciá-la!");
		return false;
	}

   // Preenche o formulário 2
   document.form2.cfgreprocessador.value = document.form1.ListaConfiguracoes.options[Indice].text;
   return true;
}
...
function Finaliza()
{
	if (document.form1.ListaConfiguracoes.length == 0)
	{
		alert ("Não há configurações de reprocessadores para finalizar!");
		return false;
	}
	...
	if (Indice == -1)
	{
		alert ("Selecione uma configuração de reprocessador para finalizá-la!");
		return false;
	}

	// Preenche o formulário 3
	document.form3.cfgreprocessador.value = document.form1.ListaConfiguracoes.options[Indice].text;
	return true;
...
function Termina()
{
	if (document.form1.ListaConfiguracoes.length == 0)
	{
		alert ("Não há configurações de reprocessadores para terminar!");
		return false;
	}
	...
	if (Indice == -1)
   {
		alert ("Selecione uma configuração de reprocessador para terminá-la!");
		return false;
	}

	// Preenche o formulário 4
	document.form4.cfgreprocessador.value = document.form1.ListaConfiguracoes.options[Indice].text;
	return true;
}