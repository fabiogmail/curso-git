...
/**
 */
public class OpListaCfgParsersGen extends OperacaoAbs 
{
   ...
   public boolean iniciaOperacao(String p_Mensagem) 
   {
      try
      {
         setOperacao("Lista Configuração de ParsersGen");
         montaTabela();
         m_Args = new String[7];
      ...
      {
         System.out.println("OpListaCfgParsersGen - iniciaOperacao(): "+Exc);
         Exc.printStackTrace();
         return false;
      }
   }
   ...
   public Vector montaLinhas()
   {
      ...
      if(DefsComum.s_CLIENTE.equalsIgnoreCase("oi"))
      {
    	  for (Iterator iter = NoUtil.listaDeNos.iterator(); iter.hasNext();)
          {
    		  ...
    		  Vector listaCfgParserGen =  noTmp.getConexaoServUtil().getListaCfgParsersGen();
    		  if(listaCfgParserGen != null){
    			  ListaConfig.addAll(listaCfgParserGen);
    		  }

          }
      }
      else  if(DefsComum.s_CLIENTE.equalsIgnoreCase("claro"))
      {
    	  for (Iterator iter = NoUtil.listaDeNos.iterator(); iter.hasNext();)
          {
    		  No noTmp = (No) iter.next();
      ...
      {
      ListaConfig = NoUtil.getNoCentral().getConexaoServUtil().getListaCfgParsersGen();
      }
   ...
   public void montaTabela() 
   {
      ...
      String Header[] = {"Configura&ccedil;&atilde;o", "Servidor", "ParserGen", "Bilhetadores"};
      ...
      m_Html.m_Tabela.setLink("/PortalOsx/servlet/Portal.cPortal?operacao=listaCfgParsersGen&tipo="+Tipo);
