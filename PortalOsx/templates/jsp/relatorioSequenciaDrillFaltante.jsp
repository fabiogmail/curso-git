...
<title>Relatorio de Sequ&ecirc;ncia - Arquivos Faltantes</title>
...
function init(pagina){
	OpRelSequenciaAjax.setExportacao(1);//setar formato HTML como padrão para download.
	OpRelSequenciaAjax.getDrillFaltante(retRelatorio, pagina);	
...
<body bgcolor="#BBBDBB" style="margin: 0px" onLoad="init(0);">
	...
	<table id="tabelaGeral" width="100%" height="100%">
		<tr>
			<td height="20px">				
				<b>&ensp;Relat&oacute;rio de Sequ&ecirc;ncia - Arquivos Faltantes</b>
			</td>
		</tr>
		<tr>
			<td align="center">				
