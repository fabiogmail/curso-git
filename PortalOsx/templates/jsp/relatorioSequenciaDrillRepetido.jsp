...
<title>Relat&oacute;rio de Sequ&ecirc;ncia - Arquivos Repetidos</title>
...
function selecPagina(pagina){
	OpRelSequenciaAjax.setExportacao(1);//setar formato HTML como padrão para download.
	OpRelSequenciaAjax.getRelatorioDrillPagina(retRelatorio, pagina);	
}

function init(pagina){
	OpRelSequenciaAjax.setExportacao(1);//setar formato HTML como padrão para download.
	OpRelSequenciaAjax.getDrillRepetido(retRelatorio, pagina);	
...
function retRelatorio(valor){
	...
	OpRelSequenciaAjax.getQtdPaginas(retQtdPaginas);
}
...
function exportar(){
	OpRelSequenciaAjax.atualizaJasper(retExportar,"drill");
	
}
function retExportar(valor){
...
<body bgcolor="#BBBDBB" style="margin: 0px" onLoad="init(0);">
	<table name="banner" border="0" cellspacing="0" cellpadding="0">
  		...
  		<tr> 
    		<td height="74" bgcolor="0D1237">
	   		<img src="../imagens/logo.gif" width="315" height="74" border="0"><img src="../imagens/meio.gif" width="243" height="74"><img src="../imagens/direita.gif" width="135" height="74">	</td>
  		</tr>
	</table>
	...
	<table id="tabelaGeral" width="100%" height="100%">
		<tr>
			<td height="20px">				
				<b>Relat&oacute;rio de Sequ&ecirc;ncia - Arquivos Repetidos</b>
			</td>
		</tr>
		<tr>
			<td align="center">				
		...
		<tr>			
			<td>		
				<div id="relatorio" style="width: 100%; height: 440px;" ></div>				
			</td>
		</tr>
	...
	<table id="tabNavegar" width="30%" height="100%" align="center">
		<tr>
			<td>
				...
				<div id="Layer1" style="position:absolute; left:500px; top:560px; width:174px; height:19px; z-index:2">
				...
				<div id="Layer2" style="position:absolute; left:550px; top:556px; width:30px; height:20px; z-index:2">
					<table>
						<tr>
							<td>
				...
				<div id="Layer3" style="position:absolute; left:430px; top:560px; width:60px; height:20px; z-index:2">
