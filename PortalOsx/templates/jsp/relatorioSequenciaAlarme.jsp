...
function init(pagina){
	OpRelSequenciaAjax.setExportacao(1);//setar formato HTML como padrão para download.
	OpRelSequenciaAjax.getRelatorioAlarme(retRelatorio, pagina);	
}
...
<body bgcolor="#BBBDBB" style="margin: 0px" onLoad="init(0);" onunload="finaliza();">
  ...
  <tr> 
    <td height="74" bgcolor="0D1237">
	   <img src="../imagens/logo.gif" width="315" height="74" border="0"><img src="../imagens/meio.gif" width="302" height="74"><img src="../imagens/direita.gif" width="191" height="74">	</td>
  </tr>
</table>

<table id="tabelaGeral" width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
		
		<tr>
			<td height="20px">				
				<b>&ensp;Alarmes de Sequ&ecirc;ncia</b>
			</td>
		</tr>
