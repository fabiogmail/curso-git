...
/**
 */
public class OpVerificaBilParsersGen extends OperacaoAbs 
{
    ...
    */
   public OpVerificaBilParsersGen() 
   {
   }
   ...
   public boolean iniciaOperacao(String p_Mensagem) 
   {
      try
      {
         setOperacao("Verificação de Configuração de ParsersGen");
   ...
   public Vector montaLinhas() 
   {
      ...
      //ListaConfig = no.getConexaoServUtil().getListaCfgParsersGen();
      No noTmp = null;
      ...
      for (Iterator iter = NoUtil.listaDeNos.iterator(); iter.hasNext();)
      {
		  ...
		  {
      	  	 noTmp = (No) iter.next();
      	  	 Vector parserGen =  noTmp.getConexaoServUtil().getListaCfgParsersGen();
      	  	 if(parserGen != null)
      	  	 	ListaConfig.addAll(parserGen);
		  }
      ...
      {
         Colunas = new Vector();
         Colunas.add("Não existe configuração de parserGen cadastrada.");
         Colunas.add("&nbsp;");
         Colunas.trimToSize();
         Linhas.add(Colunas);
      }
   ...
   public void montaTabela()
   {
      ...
      m_Html.m_Tabela.setLink("/PortalOsx/servlet/Portal.cPortal?operacao=verificaBilParsersGen");
   ...
   public String verificaBilhetadores()    {
      ...
      No no = NoUtil.getNoCentral();
      Retorno = no.getConexaoServUtil().verificaBilhetadores("parserGen");
