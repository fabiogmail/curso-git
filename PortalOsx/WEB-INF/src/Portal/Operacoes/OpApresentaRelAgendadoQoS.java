...
public class OpApresentaRelAgendadoQoS extends OperacaoAbs 
{
...
*/         
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoQoS:iniciaOperacao() - Suboperacao nao encontrada: "+ m_SubOperacao);
   ...
   public void apresentaPagInicial() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoQoS:apresentaPagInicial(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaPagInicial2() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoQoS:apresentaPagInicial2(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoQoS:apresentaRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaTopoRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoQoS:apresentaTopoRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaMeioRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoQoS:apresentaMeioRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaBaseRelatorio()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoQoS:apresentaBaseRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaIndicadores()
   {
      try
      {
         ...
         {
            QtdIndicadores = Ag.m_IndicadoresQoS.size();            
            for (i = 0; i < QtdIndicadores; i++)
               Indicadores1 += "                   <option value=\""+ Ag.m_IndicadoresQoS.elementAt(i).toString() +"\">" + Ag.m_IndicadoresQoS.elementAt(i).toString() + "</option>\n";
...
//            Indicadores2 += "                   <option value=\""+ Ag.m_vIndicadores.elementAt(i).toString() +"\">" + Ag.m_vIndicadores.elementAt(i).toString() + "</option>\n";
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoQoS:apresentaIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaConfiguracao() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoQoS:apresentaConfiguracao(): "+ Exc);
         Exc.printStackTrace();
      }    
   }
   ...
   public void apresentaRelatorioFinal() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoQoS:apresentaRelatorioFinal(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaSelecaoDePaginas() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoQoS:apresentaSelecaoDePaginas(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void apresentaLogs()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoQoS:apresentaLogs(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
...
//               Indicadores = Ag.m_vIndicadores.elementAt(0).toString()+";"+Indicadores;
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoQoS:alteraIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void alteraConfiguracao() 
   {
      ...
      if (Usuario != null)
      {
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoQoS:alteraConfiguracao(): Usuario nao foi encontrado");
   }
...
*/      
   ...
   public void home() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoQoS:home(): "+ Exc);
         Exc.printStackTrace();
      }
   }  
...
//         vCabecalho = new Vector (Ag.m_Cabecalho);
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoQoS:download(): "+ Exc);
         Exc.printStackTrace();         
      }
   }
   ...
   public static synchronized void removeAgenda(OpApresentaRelAgendadoQoS p_Operacao)
   {
      try
      {
         AgendaQoS Ag = null;
         ...
         s_MapAgendasQoS.remove(p_Operacao.m_KeyCache);
      }
      catch (Exception Exc)
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoQoS:removeAgenda(): Nao foi possivel remvoer a agenda com chave: "+p_Operacao.m_KeyCache);
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoQoS:removeAgenda(): "+ Exc);
         Exc.printStackTrace();
      }
   }

   public AgendaQoS buscaAgenda() 
   {
   ...
   public static synchronized AgendaQoS buscaAgenda(OpApresentaRelAgendadoQoS p_Operacao)
   {
      Object ObjAg = null;
      AgendaQoS Ag = null;
      
      if (s_MapAgendasQoS.size() == 0)
      {
         Ag = p_Operacao.criaAgenda();
         return Ag;
      }

      ObjAg = s_MapAgendasQoS.get(p_Operacao.m_KeyCache);
      if (ObjAg != null)
      {
         Ag = (AgendaQoS)ObjAg;
      }
   ...
   public void insereAgenda(AgendaQoS p_Agenda) 
   {
      synchronized(s_MapAgendasQoS)
      {
         s_MapAgendasQoS.put(m_KeyCache, p_Agenda);
      }      
   }

   public AgendaQoS criaAgenda() 
   {
      boolean Retorno;
      AgendaQoS Ag;
      UsuarioDef Usuario = (UsuarioDef)NoUtil.getUsuarioLogado(m_Request.getSession().getId());
      ...
      Ag = new AgendaQoS(no.getConexaoServUtil(), 
                                m_Perfil, 
                                m_TipoRelatorio, 
                                m_IdRelatorio, 
                                m_NomeArquivoRelatorio, 
                                m_SelecaoRecursosQoS, 
                                m_SelecaoIndicadorQoS,
                                m_IndicadoresQoS,
                                m_NomeRelatorio,
                                m_DataGeracao);
      m_Agenda = Ag;
...
class DownloadRelAgendadoQoS extends java.lang.Thread
   {
	...
	AgendaQoS m_Ag = null;
      ...
      public DownloadRelAgendadoQoS(String p_NomeArq, Vector p_vCabecalho, AgendaQoS p_Ag, Vector p_CfgWeb)
      {
         m_Ag = p_Ag;
         m_NomeArq = p_NomeArq;
