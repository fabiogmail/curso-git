...
public class AgendaDWGERAL extends Agenda
{
   //public String[] m_Rec = null;
   public  Vector m_Recv = null;
   private String m_Indicadores;
   public Vector m_RelatoriosProcessados[] = null;
   public Vector m_IndicadoresDWGERAL;
   
   public AgendaDWGERAL(CnxServUtil p_ConexUtil, String p_Perfil, String p_TipoRel, String p_IdRel, String p_Arquivo, SelecaoRecursosDwGeral p_SelecaoRecursosDWGERAL, SelecaoIndicadorDwGeral p_SelecaoIndicadorDWGERAL, String p_IndicadoresDWGERAL, String p_NomeRel, String p_DataGer)
   {
      super(p_ConexUtil, p_Perfil, p_TipoRel, p_IdRel, p_Arquivo, p_NomeRel, p_DataGer);

      this.setM_SelecaoRecursos(p_SelecaoRecursosDWGERAL);
      this.setM_SelecaoIndicador(p_SelecaoIndicadorDWGERAL);
      this.setM_ContadoresRelatorio(m_iRetRelatorio.fnGetContadores());
      
      m_IndicadoresDWGERAL = VetorUtil.String2Vetor(p_IndicadoresDWGERAL, ';');
