...
<title>Relat&oacute;rio de Acesso</title>
...
function init(){
	$('radio_rel_acesso').checked = true;
	$('radio_est_acesso').checked = false;
}
...
function executaRelatorio(){
	...
	if($('radio_est_acesso').checked){
		consolidado = true;
	}	
	if(data != null)
	{
		$('imgLoad').innerHTML = 'Carregando...';
		RelatorioAjax.verificaRelatorioAcesso(carregaRelatorio,usuario,dias,data[0],data[1],pg,consolidado);
	}
}
...
function carregaRelatorio(isEmpty)
{
	...
	{
		window.open("/PortalOsx/templates/segAcesso/relatorioSegAcesso.jsp",'Relatório',		'resizable=false,status=yes,menubar=no,scrollbars=false,width=740,height=560');
	}
}
...
function getDatas(){
	...
	/*if(ano != '' && mes != 0 && ano != '' && hora != '' ){
		data1 = ano+'-'+mes+'-'+dia+' '+hora+':00';
	}else{
		mensagem = 'Período inicial configurado errado.\n';
	}
	if(anoF != '' && mesF != 0 && anoF != '' && horaF != '' ){
		data2 = anoF+'-'+mesF+'-'+diaF+' '+horaF+':00';
	}else{
		mensagem += 'Período final configurado errado.';
	}*/
...
<table width="780" border="0" cellpadding="0" cellspacing="0" background="/PortalOsx/imagens/fundo.gif">
  ...
  <tr>
    <td width="630" height="20" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <!--DWLayoutTable-->
      <tr>
        <td width="630" height="20" align="left" valign="middle">&nbsp;&nbsp;&nbsp;<img src="/PortalOsx/imagens/relacesso.gif" border="0" align="middle" alt="Dica de Utilização" /></td>
      </tr>
    </table>    </td>
    <td width="150" rowspan="3" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		<p>
		&nbsp;&nbsp;Dica de utilização do Relatório de Acesso		</p>		</td>
      </tr>
  ...
  <tr>
    <td height="156" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="22">&nbsp;</td>
          <td colspan="2" align="left" valign="middle"><b>Usuario:</b></td>
          <td colspan="4" valign="middle">&nbsp;&nbsp;&nbsp;<input type="text" id="usuario" alt="informe o nome do usuario a ser pesquisado" /></td>
          <td>&nbsp;</td>
        </tr>
      <tr>
      	<td height="19">&nbsp;</td>
      ...
      <tr>
        <td height="22"/> 
        <td colspan="4" align="left" valign="middle"><b><strong>&Uacute;ltimos "n" dias:</strong></b></td>
        ...
        <td colspan="6" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="24" align="left" valign="middle"><b>Data: </b></td>
	            ...
	            <td>&nbsp;</td>
	            <td align="center" valign="middle"><b>Hora:</b></td>
	            <td valign="middle">
      ...
      <tr>
        <td height="19"></td>
        <td colspan="6" valign="top" bgcolor="#000033"><span class="style1">&nbsp;Tipos de Relat&oacute;rios</span></td>
        <td></td>
      </tr>
      ...
      <tr>
        <td height="20"></td>
        <td align="center" valign="middle" ><input type="radio" id="radio_rel_acesso" name="radio_rel"/></td>
          <td colspan="3" align="left" valign="middle" >Relat&oacute;rio de Acesso </td>
          <td valign="top" ><input type="radio" id="radio_est_acesso" name="radio_rel"/></td>
          <td align="left" valign="middle" >Estat&iacute;stica de Acesso </td>
          <td></td>
        </tr>
      <tr>
        <td height="40"></td>
      ...
      <tr>
        ...
        <td colspan="3" align="left" valign="bottom" >
          <a href="#" >
		  <img src="/PortalOsx/imagens/apresentar.gif"  onclick="executaRelatorio()" border="0" align="middle" alt="Dica de Utilização" />          </a></td>
          <td valign="bottom" >
