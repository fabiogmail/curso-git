...
public class AgendaDWGPRS extends Agenda
{
   //public String[] m_Rec = null;
   public  Vector m_Recv = null;
   private String m_Indicadores;
   public Vector m_RelatoriosProcessados[] = null;
   public Vector m_IndicadoresDWGPRS;
   
   public AgendaDWGPRS(CnxServUtil p_ConexUtil, String p_Perfil, String p_TipoRel, String p_IdRel, String p_Arquivo, SelecaoRecursosDwGprs p_SelecaoRecursosDWGPRS, SelecaoIndicadorDwGprs p_SelecaoIndicadorDWGPRS, String p_IndicadoresDWGPRS, String p_NomeRel, String p_DataGer)
   {
      super(p_ConexUtil, p_Perfil, p_TipoRel, p_IdRel, p_Arquivo, p_NomeRel, p_DataGer);

      this.setM_SelecaoRecursos(p_SelecaoRecursosDWGPRS);
      this.setM_SelecaoIndicador(p_SelecaoIndicadorDWGPRS);
      this.setM_ContadoresRelatorio(m_iRetRelatorio.fnGetContadores());
      
      m_IndicadoresDWGPRS = VetorUtil.String2Vetor(p_IndicadoresDWGPRS, ';');
