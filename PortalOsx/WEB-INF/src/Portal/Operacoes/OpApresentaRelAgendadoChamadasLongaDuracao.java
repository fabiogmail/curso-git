//Source file: C:/usr/osx/CDRView/Servlet/Portal/Operacoes/OpApresentaRelAgendadoChamadasLongaDuracao.java
...
import Portal.Utils.AgendaChamadasLongaDuracao;
...
/**
 */
public class OpApresentaRelAgendadoChamadasLongaDuracao extends OperacaoAbs 
{
   ...
   public OpApresentaRelAgendadoChamadasLongaDuracao() 
   {
   ...
   {     
      ...
      if (m_SubOperacao.toLowerCase().equals("paginicial"))
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoChamadaslongaDuracao:iniciaOperacao() - Suboperacao nao encontrada: "+ m_SubOperacao);
      return true;
   }
   ...
   public void apresentaPagInicial() 
   {
      try
      {
    	  AgendaChamadasLongaDuracao Ag = null;
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoChamadasLongaDuracao:apresentaPagInicial(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaPagInicial2() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoChamadasLongaDuracao:apresentaPagInicial2(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaRelatorio() 
   {
      try
      {
         ...
         m_Args[16] = "ChamadasLongaDuracao";
         m_Args[17] = m_Perfil;
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoChamadasLongaDuracao:apresentaRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaTopoRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoChamadasLongaDuracao:apresentaTopoRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaMeioRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoChamadasLongaDuracao:apresentaMeioRelatorios(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaBaseRelatorio()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoChamadasLongaDuracao:apresentaBaseRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaIndicadores()
   {
      try
      {
         ...
         {
            QtdIndicadores = Ag.m_IndicadoresChamadasLongaDuracao.size();
            for (i = 0; i < QtdIndicadores; i++)
               Indicadores1 += "                   <option value=\""+ Ag.m_IndicadoresChamadasLongaDuracao.elementAt(i).toString() +"\">" + Ag.m_IndicadoresChamadasLongaDuracao.elementAt(i).toString() + "</option>\n";
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoChamadasLongaDuracao:apresentaIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaConfiguracao() 
   {
      try
      {
         ...
         m_Args[13] = "ChamadasLongaDuracao";
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoChamadasLongaDuracao:apresentaConfiguracao(): "+ Exc);
         Exc.printStackTrace();
      }    
   }
   ...
   public void apresentaRelatorioFinal() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoChamadasLongaDuracao:apresentaRelatorioFinal(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaSelecaoDePaginas() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoChamadasLongaDuracao:apresentaSelecaoDePaginas(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void apresentaLogs()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoChamadasLongaDuracao:apresentaLogs(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void alteraIndicadores()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoChamadasLongaDuracao:alteraIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
...
*/
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoChamadasLongaDuracao:alteraConfiguracao(): Usuario nao foi encontrado");
   }
...
/*   
      ...
      {
         System.out.println(m_ConexUtil.getDataHoraAtual() + " OpApresentaRelAgendadoChamadasLongaDuracao:ordena(): "+ Exc);
         Exc.printStackTrace();
      }
*/      
   }
   ...
   public void home() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoChamadasLongaDuracao:home(): "+ Exc);
         Exc.printStackTrace();
      }
   }  
   ...
   public void download()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoChamadasLongaDuracao:download(): "+ Exc);
         Exc.printStackTrace();         
      }
   }
   ...
   public static synchronized void removeAgenda(OpApresentaRelAgendadoChamadasLongaDuracao p_Operacao)
   {
      try
      {
    	 AgendaChamadasLongaDuracao Ag = null;
         ...
         s_MapAgendasChamadasLongaDuracao.remove(p_Operacao.m_KeyCache);
      }
      catch (Exception Exc)
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoChamadasLongaDuracao:removeAgenda(): Nao foi possivel remvoer a agenda com chave: "+p_Operacao.m_KeyCache);
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoChamadasLongaDuracao:removeAgenda(): "+ Exc);
         Exc.printStackTrace();
      }
   }

   public AgendaChamadasLongaDuracao buscaAgenda() 
   {
   ...
   public static synchronized AgendaChamadasLongaDuracao buscaAgenda(OpApresentaRelAgendadoChamadasLongaDuracao p_Operacao)
   {
      Object ObjAg = null;
      AgendaChamadasLongaDuracao Ag = null;    
      
      if (s_MapAgendasChamadasLongaDuracao.size() == 0)
      {
         Ag = p_Operacao.criaAgenda();
         return Ag;
      }

      ObjAg = s_MapAgendasChamadasLongaDuracao.get(p_Operacao.m_KeyCache);
      if (ObjAg != null)
      {
         Ag = (AgendaChamadasLongaDuracao)ObjAg;
      }
      else
      {
         Ag = p_Operacao.criaAgenda();
   ...
   public void insereAgenda(AgendaChamadasLongaDuracao p_Agenda) 
   {
      synchronized(s_MapAgendasChamadasLongaDuracao)
      {
    	  s_MapAgendasChamadasLongaDuracao.put(m_KeyCache, p_Agenda);
      }   
   }

   public AgendaChamadasLongaDuracao criaAgenda() 
   {
      boolean Retorno;
      AgendaChamadasLongaDuracao Ag;
      UsuarioDef Usuario = (UsuarioDef)NoUtil.getUsuarioLogado(m_Request.getSession().getId());
      ...
      Ag = new AgendaChamadasLongaDuracao(no.getConexaoServUtil(), 
	                                 m_Perfil, 
	                                 m_TipoRelatorio, 
	                                 m_IdRelatorio, 
	                                 m_NomeArquivoRelatorio, 
	                                 m_SelecaoIndicadorChamadasLongaDuracao, 
	                                 m_IndicadoresChamadasLongaDuracao,
	                                 m_NomeRelatorio,
	                                 m_DataGeracao);
...
class DownloadRelAgendadoChamadasLongaDuracao extends java.lang.Thread
   {
	 ...
	 */
	AgendaChamadasLongaDuracao m_Ag = null;

      String m_NomeArq;      
      Vector m_vCabecalho;
      Vector m_CfgWeb;

      public DownloadRelAgendadoChamadasLongaDuracao(String p_NomeArq, Vector p_vCabecalho, AgendaChamadasLongaDuracao p_Ag, Vector p_CfgWeb)
      {
         m_Ag = p_Ag;
         m_NomeArq = p_NomeArq;
