//Source file: C:/usr/osx/CDRView/Servlet/Portal/Operacoes/OpApresentaRelAgendadoPesquisaIMEI.java
...
import Portal.Utils.AgendaPesquisaIMEI;
...
public class OpApresentaRelAgendadoPesquisaIMEI extends OperacaoAbs 
{
   ...
   private String m_TipoRelAgendado;
   ...
   //public static final String m_FONTE="\"arial\" size=\"1\"";
   ...
   public OpApresentaRelAgendadoPesquisaIMEI() 
   {
   ...
   {     
      ...
      m_TipoRelAgendado		 = m_Request.getParameter("tipoRelApresentado");
      if(m_TipoRelAgendado!=null)
      {
    	  if(m_TipoRelAgendado.equalsIgnoreCase("resumo"))
    	  {
    		  Agenda.TIPO_REL_IMEI = 1;//tipo resumo
    	  }
    	  else
    	  {
    		  Agenda.TIPO_REL_IMEI = 0;//tipo detalhe
    	  }
      }
      ...
      if (m_SubOperacao.toLowerCase().equals("paginicial"))
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaIMEI:iniciaOperacao() - Suboperacao nao encontrada: "+ m_SubOperacao);
      return true;
   }
   ...
   public void apresentaPagInicial() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaIMEI:apresentaPagInicial(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaPagInicial2() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendaPesquisaIMEI:apresentaPagInicial2(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaIMEI:apresentaRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaTopoRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaIMEI:apresentaTopoRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaMeioRelatorio() 
   {
      try
      {
         ...
         int QtdPaginas, Tam, Posicao = 0, iPeriodo;
         ...
         //QtdPaginas = RelProcessado.size()/Ag.m_QtdLinhasPagina;
         //jeito normal para tipo detalhe
         if(Agenda.TIPO_REL_IMEI == 0)
         {
        	 QtdPaginas = Integer.parseInt(""+Ag.m_QtdLinhasPer.elementAt(iPeriodo))/Ag.m_QtdLinhasPagina;
         }
         else
         {//tipo resumo que as linhas comecam com 12
        	 QtdPaginas = Ag.getQuantidadeLinhasPorId("12")/Ag.m_QtdLinhasPagina;
         }
         ...
         {
            if (Ag.m_Pag < QtdPaginas) Ag.m_Pag++;
            ...
            if(Agenda.TIPO_REL_IMEI == 0)
            {
            	...
            	tmp = Ag.m_RetRelatorio.getRelatorio((short)iPeriodo,Ag.m_QtdLinhasPagina);  
            }
            else//tipo pesquisaIMEI resumo alinhas 11 e 12
            {
            	//metodo que recebe o periodo, a linha e o id(linha comeca com 12;)
            	
            	Ag.m_RetRelatorio.posicionaDados((short)iPeriodo,Posicao,(short)12);
            	tmp = Ag.m_RetRelatorio.getDados((short)iPeriodo,Ag.m_QtdLinhasPagina,(short)12);            	
            }
         ...
         else if (TipoNavegacao != null && TipoNavegacao.equals("anterior"))
         {
            ...
            else
            {
            	...
            	Ag.m_RetRelatorio.posicionaDados((short)iPeriodo,Posicao,(short)12);
            	Ag.m_Linhas.add(iPeriodo, Ag.m_RetRelatorio.getDados((short)iPeriodo,Ag.m_QtdLinhasPagina,(short)12)); 
            }
         ...
         else
         {
            ...
            else
            {
            	...
            	Ag.m_RetRelatorio.posicionaDados((short)iPeriodo,Posicao,(short)12);
            	linhasAux = Ag.m_RetRelatorio.getDados((short)iPeriodo,Ag.m_QtdLinhasPagina,(short)12);
            }
            if(linhasAux.size() == 0){
            	removeAgenda();
            	Ag = criaAgenda();
            ...
            Ag.remontaRelatorios(Short.parseShort(m_TipoRelatorio));
           // RelProcessado = Ag.montaLinhas(iPeriodo,Short.parseShort(m_TipoRelatorio));
            Vector[] l_RelProcessado = Ag.getRelatoriosProcessados(); 
            RelProcessado = l_RelProcessado[iPeriodo];
         }
        ...
        // for (int j = Posicao; j < Posicao + Ag.m_QtdLinhasPagina && j < Tam; j++)
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaIMEI:apresentaMeioRelatorios(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaBaseRelatorio()
   {
      try
      {
         ...
         else//tipo resumo tem que ser outro tipo de contagem
         {
        	 Paginacao = (Ag.m_Pag + 1) + "/" + ((((Ag.getQuantidadeLinhasPorId("12"))-1)/Ag.m_QtdLinhasPagina) + 1);
         }
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaIMEI:apresentaBaseRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaIndicadores()
   {
      try
      {
         ...
         {
            QtdIndicadores = Ag.m_IndicadoresPesquisaIMEI.size();
            for (i = 0; i < QtdIndicadores; i++)
               Indicadores1 += "                   <option value=\""+ Ag.m_IndicadoresPesquisaIMEI.elementAt(i).toString() +"\">" + Ag.m_IndicadoresPesquisaIMEI.elementAt(i).toString() + "</option>\n";
            Ag.m_IndicadoresPossiveis = Indicadores1;
         }

         for (i = 0; i < Ag.m_vIndicadores.size(); i++)
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaIMEI:apresentaIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaConfiguracao() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaIMEI:apresentaConfiguracao(): "+ Exc);
         Exc.printStackTrace();
      }    
   }
   ...
   public void apresentaRelatorioFinal() 
   {
      try
      {
         ...
         /*
         m_Html.envia("<p>\n");
         m_Html.envia("<b>OSx Telecom - CDRView <sup>&reg;</sup></b><br>\n");
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaIMEI:apresentaRelatorioFinal(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaSelecaoDePaginas() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaIMEI:apresentaSelecaoDePaginas(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void apresentaLogs()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaIMEI:apresentaLogs(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void alteraIndicadores()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaIMEI:alteraIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
...
*/
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoPesquisaIMEI:alteraConfiguracao(): Usuario nao foi encontrado");
   }

   public void ordena() 
   {
/*   
      AgendaDetalheChamadas Ag = null;
      ...
      {
         System.out.println(m_ConexUtil.getDataHoraAtual() + " OpApresentaRelAgendadoDetalheChamadas:ordena(): "+ Exc);
         Exc.printStackTrace();
      }
*/      
   }
   ...
   public void home() 
   {
      ...
      try
      {
         ...
         else 
         {
           ...
           {
        	   if ((Integer.parseInt(""+Ag.getQuantidadeLinhasPorId("12")))%Ag.m_QtdLinhasPagina == 0)
					QtdPaginas = (Integer.parseInt(""+Ag.getQuantidadeLinhasPorId("12")))/Ag.m_QtdLinhasPagina;
				else
					QtdPaginas = (Integer.parseInt(""+Ag.getQuantidadeLinhasPorId("12")))/Ag.m_QtdLinhasPagina + 1;
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDPesquisaIMEI:home(): "+ Exc);
         Exc.printStackTrace();
      }
   }  
   ...
   public void download()
   {
      try
      {
         ...
         switch (Ag.getStatusArqDownload())
         {
            ...
            case Agenda.STATUS_DOWNLOAD_MONTANDO_ARQ:
				...
				//Ag.getLinhasAposCabecalho();
				//Ag.remontaRelatorios(Short.parseShort(m_TipoRelatorio));
	            //new DownloadRelAgendadoDetalheChamadas(NomeArq, vCabecalho, Ag, UsuarioAux.getConfWebAgenda());
	            //Thread.sleep(1000);
            ...
            case Agenda.STATUS_DOWNLOAD_CONCLUIDO:
	            ...
	            Ag.setStatusArqDownload(Agenda.STATUS_DOWNLOAD_PRONTO);
            break;
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDPesquisaIMEI:download(): "+ Exc);
         Exc.printStackTrace();         
      }
   }
   ...
   public static synchronized void removeAgenda(OpApresentaRelAgendadoPesquisaIMEI p_Operacao)
   {
      try
      {
    	  AgendaPesquisaIMEI Ag = null;
         ...
         if (Ag != null)
         {
			...
			if (Ag.isM_AbreRetRelatorio())
			 {
				Ag.m_iRetRelatorio.fnFecha();
				Ag.m_iListaRelatorios.fnDestroy();         
			 }
			s_MapAgendasPesquisaIMEI.remove(p_Operacao.m_KeyCache);
      }
      catch (Exception Exc)
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDetalheChamadas:removeAgenda(): Nao foi possivel remvoer a agenda com chave: "+p_Operacao.m_KeyCache);
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDetalheChamadas:removeAgenda(): "+ Exc);
         Exc.printStackTrace();
      }
   }

   public AgendaPesquisaIMEI buscaAgenda() 
   {
   ...
   public static synchronized AgendaPesquisaIMEI buscaAgenda(OpApresentaRelAgendadoPesquisaIMEI p_Operacao)
   {
      Object ObjAg = null;
      AgendaPesquisaIMEI Ag = null;    
      
      if (s_MapAgendasPesquisaIMEI.size() == 0)
      {
         Ag = p_Operacao.criaAgenda();
         return Ag;
      }

      ObjAg = s_MapAgendasPesquisaIMEI.get(p_Operacao.m_KeyCache);
      if (ObjAg != null)
      {
         Ag = (AgendaPesquisaIMEI)ObjAg;
      }
      else
      {
         Ag = p_Operacao.criaAgenda();
   ...
   public void insereAgenda(AgendaPesquisaIMEI p_Agenda) 
   {
      synchronized(s_MapAgendasPesquisaIMEI)
      {
    	  s_MapAgendasPesquisaIMEI.put(m_KeyCache, p_Agenda);
      }   
   }

   public AgendaPesquisaIMEI criaAgenda() 
   {
      boolean Retorno;
      AgendaPesquisaIMEI Ag;
      UsuarioDef Usuario = (UsuarioDef)NoUtil.getUsuarioLogado(m_Request.getSession().getId());
      ...
      Ag = new AgendaPesquisaIMEI(no.getConexaoServUtil(), 
	                                 m_Perfil, 
	                                 m_TipoRelatorio, 
	                                 m_IdRelatorio, 
	                                 m_NomeArquivoRelatorio, 
	                                 m_SelecaoIndicadorPesquisaIMEI, 
	                                 m_IndicadoresPesquisaIMEI,
	                                 m_NomeRelatorio,
	                                 m_DataGeracao);
...
class DownloadRelAgendadoDetalheChamadas extends java.lang.Thread
   {
	 ...
	 */
	AgendaPesquisaIMEI m_Ag = null;

      String m_NomeArq;      
      Vector m_vCabecalho;
      Vector m_CfgWeb;

      public DownloadRelAgendadoDetalheChamadas(String p_NomeArq, Vector p_vCabecalho, AgendaPesquisaIMEI p_Ag, Vector p_CfgWeb)
      {
         m_Ag = p_Ag;
         m_NomeArq = p_NomeArq;
      ...
      public void run()
      {
         m_Ag.setStatusArqDownload(Agenda.STATUS_DOWNLOAD_PRONTO);
