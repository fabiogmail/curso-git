...
function Inicia()
{
   if (document.form1.ListaConfiguracoes.length == 0)
	{
		alert ("Não há configurações de parsers para iniciar!");
		return false;
	}
   ...
   if (Indice == -1)
	{
		alert ("Selecione uma configuração de parser para iniciá-la!");
		return false;
	}
...
function Finaliza()
{
	if (document.form1.ListaConfiguracoes.length == 0)
	{
		alert ("Não há configurações de parsers para finalizar!");
		return false;
	}
	...
	if (Indice == -1)
	{
		alert ("Selecione uma configuração de parser para finalizá-la!");
		return false;
	}
...
function Termina()
{
	if (document.form1.ListaConfiguracoes.length == 0)
	{
		alert ("Não há configurações de parsers para terminar!");
		return false;
	}
	...
	if (Indice == -1)
   {
		alert ("Selecione uma configurção de parser para terminá-la!");
		return false;
	}
