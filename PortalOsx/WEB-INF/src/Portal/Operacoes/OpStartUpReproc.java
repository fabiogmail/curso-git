//Source file: C:/usr/osx/CDRView/Servlet/Portal/Operacoes/OpStartUpReproc.java
...
/**
 */
public class OpStartUpReproc extends OperacaoAbs 
{
   ...
   public boolean iniciaOperacao(String p_Mensagem)
   {
      try
      {
         ...
         for (Iterator iter = NoUtil.listaDeNos.iterator(); iter.hasNext();)
         {
         	 ...
         	 if(noTmp.getHostName().equalsIgnoreCase(servidor) || noTmp.getIp().equalsIgnoreCase(servidor) || NoUtil.listaDeNos.size() == 1)
         	 {
		         ...
		         {
		            setOperacao("StartUp Reprocessadores");
		            m_Resultado = noTmp.getConexaoServUtil().startUpReproc();
		         }
		         else
		         {
		            setOperacao("ShutDown Reprocessadores");
		            m_Resultado = noTmp.getConexaoServUtil().shutDownReproc();
		         }
         	 }
         ...
         if (Tipo.toLowerCase().equals("startup"))
            m_Args[2] = "reprocstartup.gif";
         else
            m_Args[2] = "reprocshutdown.gif";
      ...
      {
         System.out.println("OpStartUpReproc - iniciaOperacao(): "+Exc);
         Exc.printStackTrace();
         return false;
      }
   ...
   public void montaTabela()
   {
      ...
      m_Html.m_Tabela.setLink("/PortalOsx/servlet/Portal.cPortal?operacao=startUpReproc");
