...
public class AgendaChamadasLongaDuracao extends Agenda
{
   private String[] m_Rec = null;
   private String m_Indicadores;
   public Vector m_RelatoriosProcessados[] = null;
   public Vector m_IndicadoresChamadasLongaDuracao;
   
   public AgendaChamadasLongaDuracao(CnxServUtil p_ConexUtil, String p_Perfil, String p_TipoRel, String p_IdRel, String p_Arquivo, SelecaoIndicadorChamadasLongaDuracao p_SelecaoIndicadorChamadasLongaDuracao, String p_IndicadoresChamadasLongaDuracao, String p_NomeRel, String p_DataGer)
   {
      super(p_ConexUtil, p_Perfil, p_TipoRel, p_IdRel, p_Arquivo, p_NomeRel, p_DataGer);
      
      this.setM_SelecaoIndicador(p_SelecaoIndicadorChamadasLongaDuracao);
      this.setM_Rec(m_Rec);
      this.setM_ContadoresRelatorio(m_iRetRelatorio.fnGetContadores());
      
      m_IndicadoresChamadasLongaDuracao = VetorUtil.String2Vetor(p_IndicadoresChamadasLongaDuracao, ';');      
