...
public class AgendaDespesa extends Agenda
{
   //public String[] m_Rec = null;
   public  Vector m_Recv = null;
   private String m_Indicadores;
   public Vector m_RelatoriosProcessados[] = null;
   public Vector m_IndicadoresDespesa;
   
   public AgendaDespesa(CnxServUtil p_ConexUtil, String p_Perfil, String p_TipoRel, String p_IdRel, String p_Arquivo, SelecaoRecursosDespesa p_SelecaoRecursosDespesa, SelecaoIndicadorDespesa p_SelecaoIndicadorDespesa, String p_IndicadoresDespesa, String p_NomeRel, String p_DataGer)
   {
      super(p_ConexUtil, p_Perfil, p_TipoRel, p_IdRel, p_Arquivo, p_NomeRel, p_DataGer);

      this.setM_SelecaoRecursos(p_SelecaoRecursosDespesa);
      this.setM_SelecaoIndicador(p_SelecaoIndicadorDespesa);
      this.setM_ContadoresRelatorio(m_iRetRelatorio.fnGetContadores());
      
      m_IndicadoresDespesa = VetorUtil.String2Vetor(p_IndicadoresDespesa, ';');
