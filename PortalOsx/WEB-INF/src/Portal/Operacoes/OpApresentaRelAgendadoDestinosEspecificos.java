//Source file: C:/usr/osx/CDRView/Servlet/Portal/Operacoes/OpApresentaRelAgendadoPesquisa.java
...
import Portal.Utils.AgendaDestinosEspecificos;
...
/**
 */
public class OpApresentaRelAgendadoDestinosEspecificos extends OperacaoAbs 
{
   ...
   public OpApresentaRelAgendadoDestinosEspecificos() 
   {
   }
   ...
   {     
      ...
      if (m_SubOperacao.toLowerCase().equals("paginicial"))
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosEspecificos:iniciaOperacao() - Suboperacao nao encontrada: "+ m_SubOperacao);
      return true;
   }
   ...
   public void apresentaPagInicial() 
   {
      try
      {
         AgendaDestinosEspecificos Ag = null;
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosEspecificos:apresentaPagInicial(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaPagInicial2() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosEspecificos:apresentaPagInicial2(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosEspecificos:apresentaRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaTopoRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosEspecificos:apresentaTopoRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
...
/*
         ...
         for (int i = 0; i < Ag.m_QtdPeriodos; i++)
         {
            if (i > 0 && i % 12 == 0) m_Html.envia("</tr>\n<tr>\n");   // Cria outra linha para os períodos
               
            if (Ag.m_NomesDatas != null) NomePeriodo = Ag.m_NomesDatas.elementAt(i).toString();
            else NomePeriodo = Ag.m_Datas.elementAt(i).toString();

            if (i == iPeriodo)
               m_Html.envia("<td align=\"left\" bgcolor=\""+m_COR_PERIODOS+"\"><font face="+m_FONTE+" color=\"#FFFFFF\"><b>"+NomePeriodo+"</b></font></td>");
            else
            {
               if (Ag.m_QtdPeriodos != 1)
               {
                  m_Html.envia("<td align=\"left\"><font face="+m_FONTE+">"
                               +"<a href=\"javascript:TrocaPeriodo('"
                               +m_Perfil+"','"
                               +m_TipoRelatorio+"','"
                               +m_IdRelatorio+"','"
                               ...
                               //+m_NomeRelatorio+"','"
                               //+m_DataGeracao+"','"
                               +i+"')\""   // Período para apresentação
                               +" class=\"link\" "
                               +"onmouseover=\"window.status='Apresentar per&iacute;odo "+NomePeriodo+"';return true;\" onmouseout=\"window.status='';return true;\""
                               +">"
                               +NomePeriodo
                               +"</a>"
                               +"</font></td>\n");
                  ...
                  m_Html.envia("<td align=\"left\"><font face="+m_FONTE+">"+NomePeriodo+"</font></td>\n");               
            }
         }
         m_Html.envia("</tr>\n");
         m_Html.envia("</table>\n");
*/
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosEspecificos:apresentaMeioRelatorios(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaBaseRelatorio()
   {
      try
      {
         ...
         // Paginacao = (Ag.m_Pag + 1) + "/" + (((Ag.m_RelatoriosProcessados[Ag.m_UltProcessado].size()-1)/Ag.m_QtdLinhasPagina) + 1);
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosEspecificos:apresentaBaseRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaIndicadores()
   {
      try
      {
         ...
         {
            QtdIndicadores = Ag.m_IndicadoresDestinosEspecificos.size();
            for (i = 0; i < QtdIndicadores; i++)
               Indicadores1 += "                   <option value=\""+ Ag.m_IndicadoresDestinosEspecificos.elementAt(i).toString() +"\">" + Ag.m_IndicadoresDestinosEspecificos.elementAt(i).toString() + "</option>\n";
            Ag.m_IndicadoresPossiveis = Indicadores1;
         }

         //if (Ag.m_Rec[1] != null) i = 2;
         //else i = 1;
         for (i = 1; i < Ag.m_vIndicadores.size(); i++)
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosEspecificos:apresentaIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaConfiguracao() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosEspecificos:apresentaConfiguracao(): "+ Exc);
         Exc.printStackTrace();
      }    
   }
   ...
   public void apresentaRelatorioFinal() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosEspecificos:apresentaRelatorioFinal(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaSelecaoDePaginas() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosEspecificos:apresentaSelecaoDePaginas(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void apresentaLogs()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosEspecificos:apresentaLogs(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void alteraIndicadores()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosEspecificos:alteraIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void alteraConfiguracao() 
   {
      ...
      if (Usuario != null)
      {
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosEspecificos:alteraConfiguracao(): Usuario nao foi encontrado");
   }

   public void ordena() 
   {
/*   
      AgendaPesquisa Ag = null;
      ...
      {
         System.out.println(m_ConexUtil.getDataHoraAtual() + " OpApresentaRelAgendadoPesquisa:ordena(): "+ Exc);
         Exc.printStackTrace();
      }
*/      
   }
   ...
   public void home() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosEspecificos:home(): "+ Exc);
         Exc.printStackTrace();
      }
   }  
   ...
   public void download()
   {
      try
      {
         ...
         if (Ag.getStatusArqDownload()!= Agenda.STATUS_DOWNLOAD_CONCLUIDO)// antes era 3
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosEspecificos:download(): "+ Exc);
         Exc.printStackTrace();         
      }
   }
   ...
   public static synchronized void removeAgenda(OpApresentaRelAgendadoDestinosEspecificos p_Operacao)
   {
      try
      {
         AgendaDestinosEspecificos Ag = null;
         ...
         s_MapAgendasDestinosEspecificos.remove(p_Operacao.m_KeyCache);
      }
      catch (Exception Exc)
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosEspecificos:removeAgenda(): Nao foi possivel remvoer a agenda com chave: "+p_Operacao.m_KeyCache);
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDestinosEspecificos:removeAgenda(): "+ Exc);
      }
   }

   public AgendaDestinosEspecificos buscaAgenda() 
   {
   ...
   public static synchronized AgendaDestinosEspecificos buscaAgenda(OpApresentaRelAgendadoDestinosEspecificos p_Operacao)
   {
      Object ObjAg = null;
      AgendaDestinosEspecificos Ag = null;
      
      if (s_MapAgendasDestinosEspecificos.size() == 0)
      {
         Ag = p_Operacao.criaAgenda();
         return Ag;
      }

      ObjAg = s_MapAgendasDestinosEspecificos.get(p_Operacao.m_KeyCache);
      if (ObjAg != null)
      {
         Ag = (AgendaDestinosEspecificos)ObjAg;
      }
      else
      {
         Ag = p_Operacao.criaAgenda();
   ...
   public void insereAgenda(AgendaDestinosEspecificos p_Agenda) 
   {
      synchronized(s_MapAgendasDestinosEspecificos)
      {
         s_MapAgendasDestinosEspecificos.put(m_KeyCache, p_Agenda);
      }
   }

   public AgendaDestinosEspecificos criaAgenda() 
   {
      boolean Retorno;
      AgendaDestinosEspecificos Ag;
      UsuarioDef Usuario = (UsuarioDef)NoUtil.getUsuarioLogado(m_Request.getSession().getId());
      ...
      Ag = new AgendaDestinosEspecificos(no.getConexaoServUtil(), 
                              m_Perfil, 
                              m_TipoRelatorio, 
                              m_IdRelatorio, 
                              m_NomeArquivoRelatorio, 
                              m_SelecaoRecursosDestinosEspecificos, 
                              m_SelecaoIndicadorDestinosEspecificos, 
                              m_IndicadoresDestinosEspecificos,
                              m_NomeRelatorio,
                              m_DataGeracao);
...
class DownloadRelAgendadoDestinosEspecificos extends java.lang.Thread
   {
	 ...
	 */
	 AgendaDestinosEspecificos m_Ag = null;

      String m_NomeArq;      
      Vector m_vCabecalho;
      Vector m_CfgWeb;      

      public DownloadRelAgendadoDestinosEspecificos(String p_NomeArq, Vector p_vCabecalho, AgendaDestinosEspecificos p_Ag, Vector p_CfgWeb)
      {
         m_Ag = p_Ag;
         m_NomeArq = p_NomeArq;
