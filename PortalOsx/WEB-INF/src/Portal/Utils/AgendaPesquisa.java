...
public class AgendaPesquisa extends Agenda
{ 
   ...
   public Vector m_IndicadoresPesquisa;   

   
   public AgendaPesquisa(CnxServUtil p_ConexUtil, String p_Perfil, String p_TipoRel, String p_IdRel, String p_Arquivo, SelecaoRecursosPesquisaCodigo p_SelecaoRecursosPesquisa, SelecaoIndicadorPesquisaCodigo p_SelecaoIndicadorPesquisa, String p_IndicadoresPesquisa, String p_NomeRel, String p_DataGer)
   {
...
//      this.setM_SelecaoRecursos(p_SelecaoRecursosPesquisa);
      this.setM_SelecaoIndicador(p_SelecaoIndicadorPesquisa);
      this.setM_ContadoresRelatorio(m_iRetRelatorio.fnGetContadores());

      m_IndicadoresPesquisa = VetorUtil.String2Vetor(p_IndicadoresPesquisa, ';');
   ...
   public Vector montaLinhas(int p_Periodo, short p_TipoRel)
   {
     ...
     // ListaIndicadores.addElement(m_SelecaoRecursosPesquisa.fnGetIndicador((String)m_vIndicadores.elementAt(0),p_TipoRel));
      ...
      for (int i = 0; i < TamLinhas; i++)
      {
          ...
          * */
         if(!DefsComum.s_CLIENTE.equalsIgnoreCase("tim") || podeRemoverZero)
