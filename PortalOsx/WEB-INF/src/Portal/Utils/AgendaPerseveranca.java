...
public class AgendaPerseveranca extends Agenda
{
   public  Vector m_Recv = null;
   private String m_Indicadores;
   public  Vector m_RelatoriosProcessados[] = null;
   public  Vector m_IndicadoresPerseveranca;
   
   public AgendaPerseveranca(CnxServUtil p_ConexUtil, String p_Perfil, String p_TipoRel, String p_IdRel, String p_Arquivo, SelecaoRecursosPerseveranca p_SelecaoRecursosPerseveranca, SelecaoIndicadorPerseveranca p_SelecaoIndicadorPerseveranca, String p_IndicadoresPerseveranca, String p_NomeRel, String p_DataGer)
   {
      super(p_ConexUtil, p_Perfil, p_TipoRel, p_IdRel, p_Arquivo, p_NomeRel, p_DataGer);

      this.setM_SelecaoRecursos(p_SelecaoRecursosPerseveranca);
      this.setM_SelecaoIndicador(p_SelecaoIndicadorPerseveranca);
      this.setM_ContadoresRelatorio(m_iRetRelatorio.fnGetContadores());
      
      m_IndicadoresPerseveranca = VetorUtil.String2Vetor(p_IndicadoresPerseveranca, ';');
