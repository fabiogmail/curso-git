//Source file: C:/usr/osx/CDRView/Servlet/Portal/Operacoes/OpApresentaRelAgendadoDetalheChamadas.java
...
import Portal.Utils.AgendaDetalheChamadas;
...
/**
 */
public class OpApresentaRelAgendadoDetalheChamadas extends OperacaoAbs 
{
   ...
   public static int tamanhoLinha = 0;
   ...
   public OpApresentaRelAgendadoDetalheChamadas() 
   {
   ...
   {     
      ...
      if (m_SubOperacao.toLowerCase().equals("paginicial"))
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDetalheChamadas:iniciaOperacao() - Suboperacao nao encontrada: "+ m_SubOperacao);
      return true;
   }
   ...
   public void apresentaPagInicial() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDetalheChamadas:apresentaPagInicial(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaPagInicial2() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDetalheChamadas:apresentaPagInicial2(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDetalheChamadas:apresentaRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaTopoRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDetalheChamadas:apresentaTopoRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaMeioRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDetalheChamadas:apresentaMeioRelatorios(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaBaseRelatorio()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDetalheChamadas:apresentaBaseRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaIndicadores()
   {
      try
      {
         ...
         {
            QtdIndicadores = Ag.m_IndicadoresDetalheChamadas.size();
            for (i = 0; i < QtdIndicadores; i++)
               Indicadores1 += "                   <option value=\""+ Ag.m_IndicadoresDetalheChamadas.elementAt(i).toString() +"\">" + Ag.m_IndicadoresDetalheChamadas.elementAt(i).toString() + "</option>\n";
            Ag.m_IndicadoresPossiveis = Indicadores1;
         }
//
//       if (Ag.m_IndicadoresPossiveis == null)
//       {
////          QtdIndicadores = Ag.getM_ContadoresRelatorio().size();
//          for (i = 0; i < tamanhoLinha; i++)
//             Indicadores1 += "                   <option value=\""+ Ag.getM_ContadoresRelatorio().elementAt(i).toString() +"\">" + Ag.getM_ContadoresRelatorio().elementAt(i).toString() + "</option>\n";
//          Ag.m_IndicadoresPossiveis = Indicadores1;
//       }
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDetalheChamadas:apresentaIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaConfiguracao() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDetalheChamadas:apresentaConfiguracao(): "+ Exc);
         Exc.printStackTrace();
      }    
   }
   ...
   public void apresentaRelatorioFinal() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDetalheChamadas:apresentaRelatorioFinal(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaSelecaoDePaginas() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDetalheChamadas:apresentaSelecaoDePaginas(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void apresentaLogs()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDetalheChamadas:apresentaLogs(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void alteraIndicadores()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDetalheChamadas:alteraIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
...
*/
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDetalheChamadas:alteraConfiguracao(): Usuario nao foi encontrado");
   }
...
*/      
   ...
   public void home() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDetalheChamadas:home(): "+ Exc);
         Exc.printStackTrace();
      }
   }  
   ...
   public void download()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoDetalheChamadas:download(): "+ Exc);
         Exc.printStackTrace();         
      }
   }
   ...
   public static synchronized void removeAgenda(OpApresentaRelAgendadoDetalheChamadas p_Operacao)
   {
      try
      {
         AgendaDetalheChamadas Ag = null;
         ...
         s_MapAgendasDetalheChamadas.remove(p_Operacao.m_KeyCache);
      }
      catch (Exception Exc)
      {
   ...
   public AgendaDetalheChamadas buscaAgenda() 
   {
   ...
   public static synchronized AgendaDetalheChamadas buscaAgenda(OpApresentaRelAgendadoDetalheChamadas p_Operacao)
   {
      Object ObjAg = null;
      AgendaDetalheChamadas Ag = null;    
      
      if (s_MapAgendasDetalheChamadas.size() == 0)
      {
         Ag = p_Operacao.criaAgenda();
         return Ag;
      }

      ObjAg = s_MapAgendasDetalheChamadas.get(p_Operacao.m_KeyCache);
      if (ObjAg != null)
      {
         Ag = (AgendaDetalheChamadas)ObjAg;
      }
      else
      {
         Ag = p_Operacao.criaAgenda();
   ...
   public void insereAgenda(AgendaDetalheChamadas p_Agenda) 
   {
      synchronized(s_MapAgendasDetalheChamadas)
      {
         s_MapAgendasDetalheChamadas.put(m_KeyCache, p_Agenda);
      }   
   }

   public AgendaDetalheChamadas criaAgenda() 
   {
      boolean Retorno;
      AgendaDetalheChamadas Ag;
      UsuarioDef Usuario = (UsuarioDef)NoUtil.getUsuarioLogado(m_Request.getSession().getId());
      ...
      Ag = new AgendaDetalheChamadas(no.getConexaoServUtil(), 
	                                 m_Perfil, 
	                                 m_TipoRelatorio, 
	                                 m_IdRelatorio, 
	                                 m_NomeArquivoRelatorio, 
	                                 m_SelecaoIndicadorDetalhe, 
	                                 m_IndicadoresDetalhe,
	                                 m_NomeRelatorio,
	                                 m_DataGeracao);
...
class DownloadRelAgendadoDetalheChamadas extends java.lang.Thread
   {
	 ...
	 */
	AgendaDetalheChamadas m_Ag = null;

      String m_NomeArq;      
      Vector m_vCabecalho;
      Vector m_CfgWeb;

      public DownloadRelAgendadoDetalheChamadas(String p_NomeArq, Vector p_vCabecalho, AgendaDetalheChamadas p_Ag, Vector p_CfgWeb)
      {
         m_Ag = p_Ag;
         m_NomeArq = p_NomeArq;
