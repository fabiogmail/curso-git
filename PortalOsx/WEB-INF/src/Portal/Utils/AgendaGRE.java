...
public class AgendaGRE extends Agenda
{
   //public String[] m_Rec = null;
   public  Vector m_Recv = null;
   private String m_Indicadores;
   public Vector m_RelatoriosProcessados[] = null;
   public Vector m_IndicadoresGRE;
   
   public AgendaGRE(CnxServUtil p_ConexUtil, String p_Perfil, String p_TipoRel, String p_IdRel, String p_Arquivo, SelecaoRecursosGRE p_SelecaoRecursosGRE, SelecaoIndicadorGRE p_SelecaoIndicadorGRE, String p_IndicadoresGRE, String p_NomeRel, String p_DataGer)
   {
      super(p_ConexUtil, p_Perfil, p_TipoRel, p_IdRel, p_Arquivo, p_NomeRel, p_DataGer);

      this.setM_SelecaoRecursos(p_SelecaoRecursosGRE);
      this.setM_SelecaoIndicador(p_SelecaoIndicadorGRE);
      this.setM_ContadoresRelatorio(m_iRetRelatorio.fnGetContadores());
      
      m_IndicadoresGRE = VetorUtil.String2Vetor(p_IndicadoresGRE, ';');
