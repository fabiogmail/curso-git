  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td colspan="2" valign="middle"><input type="text" name="responsavel" id="responsavel"></td>
        <td>&nbsp;</td>
        <td valign="middle"><strong>Motivo:</strong></td>
        <td valign="middle"><input type="text" name="motivo" id="motivo"></td>
        <td>&nbsp;</td>
      </tr>  
      <tr>
        <td height="30">&nbsp;</td>
        ...
        <tr>
        <td height="25" colspan="2" valign="middle"><strong>Ordem de Serviço:</strong></td>
