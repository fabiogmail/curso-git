...
public class AgendaChamadas extends Agenda
{
   public  Vector m_Recv = null;
   private String m_Indicadores;
   public  Vector m_RelatoriosProcessados[] = null;
   public  Vector m_IndicadoresChamadas;
   
   public AgendaChamadas(CnxServUtil p_ConexUtil, String p_Perfil, String p_TipoRel, String p_IdRel, String p_Arquivo, SelecaoRecursosChamadas p_SelecaoRecursosChamadas, SelecaoIndicadorChamadas p_SelecaoIndicadorChamadas, String p_IndicadoresChamadas, String p_NomeRel, String p_DataGer)
   {
      super(p_ConexUtil, p_Perfil, p_TipoRel, p_IdRel, p_Arquivo, p_NomeRel, p_DataGer);

      this.setM_SelecaoRecursos(p_SelecaoRecursosChamadas);
      this.setM_SelecaoIndicador(p_SelecaoIndicadorChamadas);
      this.setM_ContadoresRelatorio(m_iRetRelatorio.fnGetContadores());
      
      m_IndicadoresChamadas = VetorUtil.String2Vetor(p_IndicadoresChamadas, ';');
