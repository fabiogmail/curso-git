...
public class AgendaDistribuicaoDeFrequencia extends Agenda
{
   public  Vector m_Recv = null;
   private String m_Indicadores;
   public  Vector m_RelatoriosProcessados[] = null;
   public  Vector m_IndicadoresDistribuicaoDeFrequencia;
   
   public AgendaDistribuicaoDeFrequencia (CnxServUtil p_ConexUtil, String p_Perfil, String p_TipoRel, String p_IdRel, String p_Arquivo, SelecaoRecursosDistFrequencia p_SelecaoRecursosDistribuicaoDeFrequencia, SelecaoIndicadorDistFrequencia p_SelecaoIndicadorDistribuicaoDeFrequencia, String p_IndicadoresDistribuicaoDeFrequencia, String p_NomeRel, String p_DataGer)
   {
      super(p_ConexUtil, p_Perfil, p_TipoRel, p_IdRel, p_Arquivo, p_NomeRel, p_DataGer);

      this.setM_SelecaoRecursos(p_SelecaoRecursosDistribuicaoDeFrequencia);
      this.setM_SelecaoIndicador(p_SelecaoIndicadorDistribuicaoDeFrequencia);
      this.setM_ContadoresRelatorio(m_iRetRelatorio.fnGetContadores());
      
      m_IndicadoresDistribuicaoDeFrequencia = VetorUtil.String2Vetor(p_IndicadoresDistribuicaoDeFrequencia, ';');
