...
/**
 */
public class ConfiguracaoConvCfgDef 
{
   private String m_Nome = null;
   private String m_Servidor = null;
   private String m_Conversor = null;
    ...
    */
   public ConfiguracaoConvCfgDef(String p_Nome, String p_Servidor, String p_Conversor, Vector p_Bilhetadores, String p_Relacionamento) 
   {
      m_Nome = p_Nome;
      m_Servidor = p_Servidor;
      m_Conversor = p_Conversor;
