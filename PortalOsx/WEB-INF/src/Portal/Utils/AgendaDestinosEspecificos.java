...
public class AgendaDestinosEspecificos extends Agenda
{
   ...
   public Vector m_IndicadoresDestinosEspecificos;   

   
   public AgendaDestinosEspecificos(CnxServUtil p_ConexUtil, String p_Perfil, String p_TipoRel, String p_IdRel, String p_Arquivo, SelecaoRecursosDestinosEspecificos p_SelecaoRecursosDestinosEspecificos, SelecaoIndicadorDestinosEspecificos p_SelecaoIndicadorDestinosEspecificos, String p_IndicadoresDestinosEspecificos, String p_NomeRel, String p_DataGer)
   {
...
//      this.setM_SelecaoRecursos(p_SelecaoRecursosPesquisa);
      this.setM_SelecaoIndicador(p_SelecaoIndicadorDestinosEspecificos);
      this.setM_ContadoresRelatorio(m_iRetRelatorio.fnGetContadores());

      m_IndicadoresDestinosEspecificos = VetorUtil.String2Vetor(p_IndicadoresDestinosEspecificos, ';');
