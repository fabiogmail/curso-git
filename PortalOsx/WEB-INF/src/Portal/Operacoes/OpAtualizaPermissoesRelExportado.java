...
/**
 */
public class OpAtualizaPermissoesRelExportado extends OperacaoAbs 
{
    ...
    */
   public OpAtualizaPermissoesRelExportado() 
   {
   }
   ...
   public boolean iniciaOperacao(String p_Mensagem) 
   {
      ...
      OpApresentaPermissoesBasesExportadas OpPermissoes = new OpApresentaPermissoesBasesExportadas();
      ...
      if (no.getConexaoServUtil().atualizaPermissaoBaseExportada(Chave, Permissoes))
      {
