...
import Portal.Operacoes.OpApresentaRelAgendadoDetalheChamadas;


public class AgendaDetalheChamadas extends Agenda
{
   private String[] m_Rec = null;
   private String m_Indicadores;
   public Vector m_RelatoriosProcessados[] = null;
   public Vector m_IndicadoresDetalheChamadas;
   
   public AgendaDetalheChamadas(CnxServUtil p_ConexUtil, String p_Perfil, String p_TipoRel, String p_IdRel, String p_Arquivo, SelecaoIndicadorDetalheChamada p_SelecaoIndicadorDetalhe, String p_IndicadoresDetalheChamadas, String p_NomeRel, String p_DataGer)
   {
      super(p_ConexUtil, p_Perfil, p_TipoRel, p_IdRel, p_Arquivo, p_NomeRel, p_DataGer);
      
      this.setM_SelecaoIndicador(p_SelecaoIndicadorDetalhe);
      this.setM_Rec(m_Rec);
      this.setM_ContadoresRelatorio(m_iRetRelatorio.fnGetContadores());
      
      m_IndicadoresDetalheChamadas = VetorUtil.String2VetorUnique(p_IndicadoresDetalheChamadas, ';');      
   ...
   {      
      ...
      for (int i = 0; i < l_NumLinhas; i++)
      {
         ...
         OpApresentaRelAgendadoDetalheChamadas.tamanhoLinha = libjava.tipos.TipoDadoString.fnTokenLinha(Aux).length;
