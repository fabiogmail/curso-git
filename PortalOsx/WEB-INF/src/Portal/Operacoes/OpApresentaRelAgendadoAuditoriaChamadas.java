//Source file: C:/usr/osx/CDRView/Servlet/Portal/Operacoes/OpApresentaRelAgendadoAuditoriaChamadas.java
...
import Portal.Utils.AgendaAuditoriaChamadas;
...
/**
 */
public class OpApresentaRelAgendadoAuditoriaChamadas extends OperacaoAbs 
{
   ...
   public OpApresentaRelAgendadoAuditoriaChamadas() 
   {
   ...
   {     
      ...
      if (m_SubOperacao.toLowerCase().equals("paginicial"))
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoAuditoriaChamadas:iniciaOperacao() - Suboperacao nao encontrada: "+ m_SubOperacao);
      return true;
   }
   ...
   public void apresentaPagInicial() 
   {
      try
      {
    	  AgendaAuditoriaChamadas Ag = null;
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoAuditoriaChamadas:apresentaPagInicial(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaPagInicial2() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoAuditoriaChamadas:apresentaPagInicial2(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoAuditoriaChamadas:apresentaRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaTopoRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoAuditoriaChamadas:apresentaTopoRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaMeioRelatorio() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoAuditoriaChamadas:apresentaMeioRelatorios(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaBaseRelatorio()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoAuditoriaChamadas:apresentaBaseRelatorio(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaIndicadores()
   {
      try
      {
         ...
         {
            QtdIndicadores = Ag.m_IndicadoresAuditoriaChamadas.size();
            for (i = 0; i < QtdIndicadores; i++)
               Indicadores1 += "                   <option value=\""+ Ag.m_IndicadoresAuditoriaChamadas.elementAt(i).toString() +"\">" + Ag.m_IndicadoresAuditoriaChamadas.elementAt(i).toString() + "</option>\n";
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoAuditoriaChamadas:apresentaIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaConfiguracao() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoAuditoriaChamadas:apresentaConfiguracao(): "+ Exc);
         Exc.printStackTrace();
      }    
   }
   ...
   public void apresentaRelatorioFinal() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoAuditoriaChamadas:apresentaRelatorioFinal(): "+ Exc);
         Exc.printStackTrace();
      }
   }
   ...
   public void apresentaSelecaoDePaginas() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoAuditoriaChamadas:apresentaSelecaoDePaginas(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void apresentaLogs()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoAuditoriaChamadas:apresentaLogs(): "+ Exc);
         Exc.printStackTrace();
      }   
   }
   ...
   public void alteraIndicadores()
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoAuditoriaChamadas:alteraIndicadores(): "+ Exc);
         Exc.printStackTrace();
      }
   }
...
*/
         ...
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoAuditoriaChamadas:alteraConfiguracao(): Usuario nao foi encontrado");
   }
...
/*   
      ...
      {
         System.out.println(m_ConexUtil.getDataHoraAtual() + " OpApresentaRelAgendadoAuditoriaChamadas:ordena(): "+ Exc);
         Exc.printStackTrace();
      }
*/      
   }
   ...
   public void home() 
   {
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoAuditoriaChamadas:home(): "+ Exc);
         Exc.printStackTrace();
      }
   }  
   ...
   public void download()
   {
      try
      {
         ...
         switch (Ag.getStatusArqDownload())
         {
            ...
            case Agenda.STATUS_DOWNLOAD_MONTANDO_ARQ:
				...
				//Ag.getLinhasAposCabecalho();
				//Ag.remontaRelatorios(Short.parseShort(m_TipoRelatorio));
	            //new DownloadRelAgendadoAuditoriaChamadas(NomeArq, vCabecalho, Ag, UsuarioAux.getConfWebAgenda());
	            //Thread.sleep(1000);
      ...
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoAuditoriaChamadas:download(): "+ Exc);
         Exc.printStackTrace();         
      }
   }
   ...
   public static synchronized void removeAgenda(OpApresentaRelAgendadoAuditoriaChamadas p_Operacao)
   {
      try
      {
         AgendaAuditoriaChamadas Ag = null;
         ...
         s_MapAgendasAuditoriaChamadas.remove(p_Operacao.m_KeyCache);
      }
      catch (Exception Exc)
      {
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoAuditoriaChamadas:removeAgenda(): Nao foi possivel remvoer a agenda com chave: "+p_Operacao.m_KeyCache);
         System.out.println(NoUtil.getNo().getConexaoServUtil().getDataHoraAtual() + " OpApresentaRelAgendadoAuditoriaChamadas:removeAgenda(): "+ Exc);
         Exc.printStackTrace();
      }
   }

   public AgendaAuditoriaChamadas buscaAgenda() 
   {
   ...
   public static synchronized AgendaAuditoriaChamadas buscaAgenda(OpApresentaRelAgendadoAuditoriaChamadas p_Operacao)
   {
      Object ObjAg = null;
      AgendaAuditoriaChamadas Ag = null;    
      
      if (s_MapAgendasAuditoriaChamadas.size() == 0)
      {
         Ag = p_Operacao.criaAgenda();
         return Ag;
      }

      ObjAg = s_MapAgendasAuditoriaChamadas.get(p_Operacao.m_KeyCache);
      if (ObjAg != null)
      {
         Ag = (AgendaAuditoriaChamadas)ObjAg;
      }
      else
      {
         Ag = p_Operacao.criaAgenda();
   ...
   public void insereAgenda(AgendaAuditoriaChamadas p_Agenda) 
   {
      synchronized(s_MapAgendasAuditoriaChamadas)
      {
         s_MapAgendasAuditoriaChamadas.put(m_KeyCache, p_Agenda);
      }   
   }

   public AgendaAuditoriaChamadas criaAgenda() 
   {
      boolean Retorno;
      AgendaAuditoriaChamadas Ag;
      UsuarioDef Usuario = (UsuarioDef)NoUtil.getUsuarioLogado(m_Request.getSession().getId());
      ...
      Ag = new AgendaAuditoriaChamadas(no.getConexaoServUtil(), 
	                                 m_Perfil, 
	                                 m_TipoRelatorio, 
	                                 m_IdRelatorio, 
	                                 m_NomeArquivoRelatorio, 
	                                 m_SelecaoIndicadorAuditoria, 
	                                 m_IndicadoresAuditoria,
	                                 m_NomeRelatorio,
	                                 m_DataGeracao);
...
class DownloadRelAgendadoAuditoriaChamadas extends java.lang.Thread
   {
	 ...
	 */
	AgendaAuditoriaChamadas m_Ag = null;

      String m_NomeArq;      
      Vector m_vCabecalho;
      Vector m_CfgWeb;

      public DownloadRelAgendadoAuditoriaChamadas(String p_NomeArq, Vector p_vCabecalho, AgendaAuditoriaChamadas p_Ag, Vector p_CfgWeb)
      {
         m_Ag = p_Ag;
         m_NomeArq = p_NomeArq;
