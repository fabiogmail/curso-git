...
function MontaListaPerfis()
{
	...
	else alert ("Servidor nao enviou a lista de Perfis!");
}
...
function Inclui()
{
	...
	else
	{
		// Preenche o formulario 2
   		...
   		//altera??o para a claro
		if(document.form1.tipoInclusao[0].checked)
		{
			document.form2.automatico.value = "true"; 
			document.form2.noEspecifico.value = "";
		}
		else
		{
			document.form2.automatico.value = "false";
			document.form2.noEspecifico.value = document.form1.ListaNosDisponiveis.value;		
		}
...
function Exclui()
{
	...
	{
		alert ("Nao ha perfis para apagar!");
		return false;
	}
...
*/
	...
	{
		alert ("Selecione um perfil para apaga-lo!");
		return false;
	}
}
...
function Bloqueia()
{
	if (document.form1.ListaPerfis.length == 0)
	{
		alert ("Nao ha perfis para bloquear!");
		return false;
	}
	...
	if (Indice != -1)
	{
		if (document.form1.ListaPerfis.options[Indice].text == "admin")
		{
			alert ("O perfil \"admin\" n&atilde;o pode ser bloqueado!");
			return false;
		}
	...
	{
		alert ("Selecione um perfil para bloquea-lo!");
		return false;
	}
}
...
function ocultaOpcaoCadastro(){
	
  var Indice = document.form1.ListaPerfis.selectedIndex;
  if(Indice!=0)
  {
  	ocultarObjeto('opcaoCadastro');  	
  }
  else{
  	mostrarObjeto('opcaoCadastro');
  }
}
