...
function LimpaForm()
{
   document.form1.Processo.selectedIndex = -1;
...
function ValidaForm()
{
	if (document.form1.Processo.selectedIndex == -1)
	{
		alert ("Não há processo selecionado!");
		return false;
	}
   ...
   if (VerificaHora('inicial') == false)
	...
	document.form1.idprocesso.value = document.form1.Processo.options[document.form1.Processo.selectedIndex].value;
	document.form1.processo.value = document.form1.Processo.options[document.form1.Processo.selectedIndex].text;
