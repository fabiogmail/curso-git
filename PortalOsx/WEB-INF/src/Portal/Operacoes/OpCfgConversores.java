...
/**
 */
public class OpCfgConversores extends OperacaoAbs 
{
   ...
   public boolean iniciaOperacao(String p_Mensagem) 
   {
      ...
      try
      {
         setOperacao("Configuração de Conversores");

         iniciaArgs(7);
         m_Args[0] = NoUtil.getNo().getDiretorioDefs().getS_DIR_TMPL_HTML();
         m_Args[1] = "formgen.htm";
         m_Args[2] = "src=\"/PortalOsx/templates/js/cfgconversores.js\"";
         m_Args[3] = "onLoad=\"Processa(0)\"";
         m_Args[4] = "cfgconversores.gif";
         m_Args[5] = m_Html.criaFormulario(NoUtil.getNo().getDiretorioDefs().getS_DIR_TMPL_FORMS(), "cfgconversores.form", montaFormulario(p_Mensagem));
         m_Args[6] = m_Html.leFormulario(NoUtil.getNo().getDiretorioDefs().getS_DIR_TMPL_TXT(), "cfgconversores.txt", null);
         m_Html.enviaArquivo(m_Args);
         return true;
      }
      catch (Exception Exc)
      {
         System.out.println("OpCfgConversores - iniciaOperacao(): "+Exc);
         Exc.printStackTrace();
         return false;
      }
   }
